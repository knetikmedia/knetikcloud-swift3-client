...
open class Users_InventoryAPI: APIBase {
    /**
  ...
  "properties" : [ {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func updateUserInventoryStatus(userId: Int32, id: Int32, inventoryStatus: InventoryStatusWrapper? = nil, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func updateUserInventoryStatusWithRequestBuilder(userId: Int32, id: Int32, inventoryStatus: InventoryStatusWrapper? = nil) -> RequestBuilder<Void> {
