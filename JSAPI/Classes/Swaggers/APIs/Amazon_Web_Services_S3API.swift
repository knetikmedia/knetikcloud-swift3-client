//
// Amazon_Web_Services_S3API.swift
//
...
open class Amazon_Web_Services_S3API: APIBase {
    /**
     Get a temporary signed S3 URL for download
     - parameter bucket: (query) S3 bucket name (optional)
     - parameter path: (query) The path to the file relative to the bucket (the s3 object key) (optional)
