...
open class Campaigns_ChallengesAPI: APIBase {
    /**
     Create a challenge
  ...
  "first" : true
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getChallenges(filterActiveCampaign: Bool? = nil, filterStartDate: String? = nil, filterEndDate: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: @escaping ((_ data: PageResourceChallengeResource?, _ error: ErrorResponse?) -> Void)) {
  ...
  "first" : true
     ...
     */
    open class func getChallengesWithRequestBuilder(filterActiveCampaign: Bool? = nil, filterStartDate: String? = nil, filterEndDate: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageResourceChallengeResource> {
        let path = "/challenges"
        let URLString = JSAPIAPI.basePath + path
        let parameters: [String:Any]? = nil
  ...
  "start_date" : 2
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func updateChallengeActivity(id: Int64, challengeId: Int64, challengeActivityResource: ChallengeActivityResource? = nil, validateSettings: Bool? = nil, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func updateChallengeActivityWithRequestBuilder(id: Int64, challengeId: Int64, challengeActivityResource: ChallengeActivityResource? = nil, validateSettings: Bool? = nil) -> RequestBuilder<Void> {
        var path = "/challenges/{challenge_id}/activities/{id}"
        path = path.replacingOccurrences(of: "{id}", with: "\(id)", options: .literal, range: nil)
        path = path.replacingOccurrences(of: "{challenge_id}", with: "\(challengeId)", options: .literal, range: nil)
        let URLString = JSAPIAPI.basePath + path
