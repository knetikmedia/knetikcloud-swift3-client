...
open class Store_CouponsAPI: APIBase {
    /**
  ...
  "properties" : [ {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getCouponItemBySku(sku: String, completion: @escaping ((_ data: CouponItem?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<CouponItem> 
     */
    open class func getCouponItemBySkuWithRequestBuilder(sku: String) -> RequestBuilder<CouponItem> {
