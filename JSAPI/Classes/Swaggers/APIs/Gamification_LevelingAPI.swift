//
// Gamification_LevelingAPI.swift
//
...
open class Gamification_LevelingAPI: APIBase {
    /**
  ...
  "first" : true
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getUserLevel(userId: String, name: String, completion: @escaping ((_ data: UserLevelingResource?, _ error: ErrorResponse?) -> Void)) {
  ...
  "next_tier_progress" : 6
     ...
     */
    open class func getUserLevelWithRequestBuilder(userId: String, name: String) -> RequestBuilder<UserLevelingResource> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getUserLevels(userId: String, filterName: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: @escaping ((_ data: PageResourceUserLevelingResource?, _ error: ErrorResponse?) -> Void)) {
  ...
  "first" : true
     ...
     */
    open class func getUserLevelsWithRequestBuilder(userId: String, filterName: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageResourceUserLevelingResource> {
