...
open class Gamification_TriviaAPI: APIBase {
    /**
  ...
  "status" : "PENDING_VALIDATION"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func searchQuestionTags(filterSearch: String? = nil, filterCategory: String? = nil, filterImportId: Int64? = nil, completion: @escaping ((_ data: [String]?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<[String]> 
     */
    open class func searchQuestionTagsWithRequestBuilder(filterSearch: String? = nil, filterCategory: String? = nil, filterImportId: Int64? = nil) -> RequestBuilder<[String]> {
