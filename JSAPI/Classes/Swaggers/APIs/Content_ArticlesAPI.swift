...
open class Content_ArticlesAPI: APIBase {
    /**
  ...
  "properties" : [ {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func createTemplate(typeHint: String, template: TemplateResource? = nil, completion: @escaping ((_ data: TemplateResource?, _ error: ErrorResponse?) -> Void)) {
  ...
  "properties" : [ {
    ...
    "required" : false
     ...
     - returns: RequestBuilder<TemplateResource> 
     */
    open class func createTemplateWithRequestBuilder(typeHint: String, template: TemplateResource? = nil) -> RequestBuilder<TemplateResource> {
        var path = "/templates/{type_hint}"
        path = path.replacingOccurrences(of: "{type_hint}", with: "\(typeHint)", options: .literal, range: nil)
        let URLString = JSAPIAPI.basePath + path
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func deleteTemplate(typeHint: String, id: String, cascade: String? = nil, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func deleteTemplateWithRequestBuilder(typeHint: String, id: String, cascade: String? = nil) -> RequestBuilder<Void> {
  ...
  "first" : true
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getTemplate(typeHint: String, id: String, completion: @escaping ((_ data: TemplateResource?, _ error: ErrorResponse?) -> Void)) {
  ...
  "properties" : [ {
    ...
    "required" : false
     ...
     - returns: RequestBuilder<TemplateResource> 
     */
    open class func getTemplateWithRequestBuilder(typeHint: String, id: String) -> RequestBuilder<TemplateResource> {
        var path = "/templates/{type_hint}/{id}"
        path = path.replacingOccurrences(of: "{type_hint}", with: "\(typeHint)", options: .literal, range: nil)
        path = path.replacingOccurrences(of: "{id}", with: "\(id)", options: .literal, range: nil)
        let URLString = JSAPIAPI.basePath + path
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getTemplates(typeHint: String, size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: @escaping ((_ data: PageResourceTemplateResource?, _ error: ErrorResponse?) -> Void)) {
  ...
  "first" : true
     ...
     - returns: RequestBuilder<PageResourceTemplateResource> 
     */
    open class func getTemplatesWithRequestBuilder(typeHint: String, size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageResourceTemplateResource> {
        var path = "/templates/{type_hint}"
        path = path.replacingOccurrences(of: "{type_hint}", with: "\(typeHint)", options: .literal, range: nil)
        let URLString = JSAPIAPI.basePath + path
        let parameters: [String:Any]? = nil
  ...
  "properties" : [ {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func updateTemplate(typeHint: String, id: String, template: TemplateResource? = nil, completion: @escaping ((_ data: TemplateResource?, _ error: ErrorResponse?) -> Void)) {
  ...
  "properties" : [ {
    ...
    "required" : false
     ...
     - returns: RequestBuilder<TemplateResource> 
     */
    open class func updateTemplateWithRequestBuilder(typeHint: String, id: String, template: TemplateResource? = nil) -> RequestBuilder<TemplateResource> {
        var path = "/templates/{type_hint}/{id}"
        path = path.replacingOccurrences(of: "{type_hint}", with: "\(typeHint)", options: .literal, range: nil)
        path = path.replacingOccurrences(of: "{id}", with: "\(id)", options: .literal, range: nil)
        let URLString = JSAPIAPI.basePath + path
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func validate(typeHint: String, resource: BasicTemplatedResource? = nil, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func validateWithRequestBuilder(typeHint: String, resource: BasicTemplatedResource? = nil) -> RequestBuilder<Void> {
