...
open class MessagingTopicsAPI: APIBase {
    /**
  ...
  "username" : "username"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getTopicSubscribers(id: String, completion: @escaping ((_ data: PageResourceTopicSubscriberResource?, _ error: ErrorResponse?) -> Void)) {
  ...
  "first" : true
     ...
     */
    open class func getTopicSubscribersWithRequestBuilder(id: String) -> RequestBuilder<PageResourceTopicSubscriberResource> {
