...
open class MediaModerationAPI: APIBase {
  ...
  "resolved" : 1
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getModerationReports(excludeResolved: Bool? = nil, filterContext: String? = nil, filterContextId: String? = nil, size: Int32? = nil, page: Int32? = nil, completion: @escaping ((_ data: PageResourceFlagReportResource?, _ error: ErrorResponse?) -> Void)) {
  ...
  "first" : true
     ...
     */
    open class func getModerationReportsWithRequestBuilder(excludeResolved: Bool? = nil, filterContext: String? = nil, filterContextId: String? = nil, size: Int32? = nil, page: Int32? = nil) -> RequestBuilder<PageResourceFlagReportResource> {
