...
open class ReportingRevenueAPI: APIBase {
  ...
  "sales_average" : 7.463186731917286,
  "sale_count" : 8,
  "sales_total" : 0.37986344290082297,
  "customer_count" : 1
}}]
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 1.6705319621792891,
  "sale_count" : 0,
  "sales_total" : 9.862284258305268,
  "customer_count" : 8
}}]
  ...
  "first" : true
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 8.741338577956379,
  "sale_count" : 3,
  "sales_total" : 9.56460542557475,
  "customer_count" : 9
}}]
