...
open class ReportingRevenueAPI: APIBase {
  ...
  "sales_average" : 4.002662468223192,
  "sale_count" : 1,
  "sales_total" : 8.288466425059092,
  "customer_count" : 3
}}]
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 2.0068924034398683,
  "sale_count" : 6,
  "sales_total" : 1.8134764193447883,
  "customer_count" : 7
}}]
  ...
  "first" : true
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 5.396216991564019,
  "sale_count" : 5,
  "sales_total" : 7.571311454927691,
  "customer_count" : 6
}}]
