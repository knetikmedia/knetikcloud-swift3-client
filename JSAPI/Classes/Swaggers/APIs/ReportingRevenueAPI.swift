...
open class ReportingRevenueAPI: APIBase {
  ...
  "sales_average" : 3.833187160718855,
  "sale_count" : 7,
  "sales_total" : 4.685326118997751,
  "customer_count" : 4
}}]
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 2.206040207490876,
  "sale_count" : 4,
  "sales_total" : 0.8272404562624336,
  "customer_count" : 8
}}]
  ...
  "first" : true
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 8.418532498722627,
  "sale_count" : 3,
  "sales_total" : 4.527701927616832,
  "customer_count" : 4
}}]
