...
open class ContentCommentsAPI: APIBase {
  ...
  "first" : true
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func searchComments(query: Any? = nil, size: Int32? = nil, page: Int32? = nil, completion: @escaping ((_ data: PageResourceCommentResource?, _ error: ErrorResponse?) -> Void)) {
  ...
  "first" : true
     ...
     - returns: RequestBuilder<PageResourceCommentResource> 
     */
    open class func searchCommentsWithRequestBuilder(query: Any? = nil, size: Int32? = nil, page: Int32? = nil) -> RequestBuilder<PageResourceCommentResource> {
