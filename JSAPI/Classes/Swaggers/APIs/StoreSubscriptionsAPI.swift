...
open class StoreSubscriptionsAPI: APIBase {
  ...
  "plans" : [ {
    "end_date" : 3,
    "initial_fee" : 5.029098603319369,
    "late_payment_fee" : 9.05353427923915,
    "billing_cycle_length" : 1,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 3.2842428763855116,
    "min_cycles" : 3,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 6,
    ...
    "reactivation_fee" : 7.362080441759168,
    "max_cycles" : 5
  } ],
  "store_start" : 0,
  "vendor_id" : 9,
  ...
  "plans" : [ {
    "end_date" : 0,
    "initial_fee" : 2.4675174004480107,
    "late_payment_fee" : 6.6848520509245954,
    "billing_cycle_length" : 9,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 6.981939729061496,
    "min_cycles" : 8,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 4,
    "additional_properties" : {
    ...
    "name" : "aeiou",
    "billing_cycle_unit" : "millisecond",
    "reactivation_fee" : 9.41973017634181,
    "max_cycles" : 5
  } ],
  "store_start" : 4,
  "vendor_id" : 2,
  ...
  "content" : [ {
    ...
    "plans" : [ {
      "end_date" : 8,
      "initial_fee" : 5.203888017106796,
      "late_payment_fee" : 1.5986537314269345,
      "billing_cycle_length" : 3,
      "reactivation_sku" : "aeiou",
      "currency_code" : "aeiou",
      "recurring_fee" : 8.124026510465374,
      "min_cycles" : 4,
      "recurring_sku" : "aeiou",
      "max_bill_attempts" : 9,
      "additional_properties" : {
      ...
      "name" : "aeiou",
      "billing_cycle_unit" : "millisecond",
      "reactivation_fee" : 1.6457381964770779,
      "max_cycles" : 9
    } ],
    "store_start" : 8,
    "vendor_id" : 3,
