...
open class StoreSubscriptionsAPI: APIBase {
  ...
  "plans" : [ {
    "end_date" : 9,
    "initial_fee" : 2.650949998293417,
    "late_payment_fee" : 4.674635212640773,
    "billing_cycle_length" : 1,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 4.525908190190199,
    "min_cycles" : 0,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 4,
    ...
    "reactivation_fee" : 4.770189033238257,
    "max_cycles" : 0
  } ],
  "store_start" : 1,
  "vendor_id" : 9,
  ...
  "plans" : [ {
    "end_date" : 7,
    "initial_fee" : 9.332233354373159,
    "late_payment_fee" : 4.581515100187355,
    "billing_cycle_length" : 7,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 7.915479146466914,
    "min_cycles" : 0,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 1,
    "additional_properties" : {
    ...
    "name" : "aeiou",
    "billing_cycle_unit" : "millisecond",
    "reactivation_fee" : 1.6523701025635928,
    "max_cycles" : 3
  } ],
  "store_start" : 7,
  "vendor_id" : 1,
  ...
  "content" : [ {
    ...
    "plans" : [ {
      "end_date" : 7,
      "initial_fee" : 1.4095961173857174,
      "late_payment_fee" : 7.279280321415299,
      "billing_cycle_length" : 2,
      "reactivation_sku" : "aeiou",
      "currency_code" : "aeiou",
      "recurring_fee" : 7.293559675435352,
      "min_cycles" : 7,
      "recurring_sku" : "aeiou",
      "max_bill_attempts" : 8,
      "additional_properties" : {
      ...
      "name" : "aeiou",
      "billing_cycle_unit" : "millisecond",
      "reactivation_fee" : 8.920013106519834,
      "max_cycles" : 4
    } ],
    "store_start" : 6,
    "vendor_id" : 1,
