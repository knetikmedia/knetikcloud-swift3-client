...
open class StoreSubscriptionsAPI: APIBase {
  ...
  "plans" : [ {
    "end_date" : 4,
    "initial_fee" : 2.867653891688181,
    "late_payment_fee" : 8.95314425308819,
    "billing_cycle_length" : 1,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 6.8247906494797,
    "min_cycles" : 3,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 2,
    ...
    "reactivation_fee" : 3.99536834923106,
    "max_cycles" : 2
  } ],
  "store_start" : 0,
  "vendor_id" : 5,
  ...
  "plans" : [ {
    "end_date" : 8,
    "initial_fee" : 7.624161922935386,
    "late_payment_fee" : 8.852556185384003,
    "billing_cycle_length" : 5,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 2.4934661413770476,
    "min_cycles" : 5,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 7,
    "additional_properties" : {
    ...
    "name" : "aeiou",
    "billing_cycle_unit" : "millisecond",
    "reactivation_fee" : 2.3889383260900434,
    "max_cycles" : 7
  } ],
  "store_start" : 3,
  "vendor_id" : 2,
  ...
  "content" : [ {
    ...
    "plans" : [ {
      "end_date" : 3,
      "initial_fee" : 9.795994600893945,
      "late_payment_fee" : 1.7818413911991293,
      "billing_cycle_length" : 6,
      "reactivation_sku" : "aeiou",
      "currency_code" : "aeiou",
      "recurring_fee" : 9.263657224819843,
      "min_cycles" : 1,
      "recurring_sku" : "aeiou",
      "max_bill_attempts" : 1,
      "additional_properties" : {
      ...
      "name" : "aeiou",
      "billing_cycle_unit" : "millisecond",
      "reactivation_fee" : 5.686844299761868,
      "max_cycles" : 6
    } ],
    "store_start" : 3,
    "vendor_id" : 0,
