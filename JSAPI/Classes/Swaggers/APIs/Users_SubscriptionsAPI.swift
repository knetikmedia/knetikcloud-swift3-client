...
open class Users_SubscriptionsAPI: APIBase {
    /**
  ...
  "shipping_postal_code" : "shipping_postal_code"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func setSubscriptionStatus(userId: Int32, inventoryId: Int32, status: SubscriptionStatusWrapper, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func setSubscriptionStatusWithRequestBuilder(userId: Int32, inventoryId: Int32, status: SubscriptionStatusWrapper) -> RequestBuilder<Void> {
