...
open class StoreBundlesAPI: APIBase {
  ...
  "skus" : [ {
    "sale_id" : 4,
    "original_price" : 4.106290992127802,
    "description" : "aeiou",
    "stop_date" : 4,
    "published" : false,
    "inventory" : 4,
  ...
  "bundled_skus" : [ {
    "quantity" : 6,
    "price_override" : 5.988811073614525,
    "sku" : "aeiou"
  } ],
  ...
  "skus" : [ {
    "sale_id" : 5,
    "original_price" : 8.615727960827762,
    "description" : "aeiou",
    "stop_date" : 1,
    "published" : false,
    "inventory" : 0,
  ...
  "bundled_skus" : [ {
    "quantity" : 3,
    "price_override" : 3.6430498333920336,
    "sku" : "aeiou"
  } ],
  "long_description" : "aeiou",
  "sort" : 2,
  ...
  "skus" : [ {
    "sale_id" : 4,
    "original_price" : 4.9739263657416535,
    "description" : "aeiou",
    "stop_date" : 5,
    "published" : false,
    "inventory" : 0,
  ...
  "bundled_skus" : [ {
    "quantity" : 5,
    "price_override" : 3.824203893356055,
    "sku" : "aeiou"
  } ],
  "long_description" : "aeiou",
  "sort" : 2,
