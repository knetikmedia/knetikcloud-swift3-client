...
open class Users_GroupsAPI: APIBase {
    /**
  ...
  "recipient_id" : "recipient_id"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func updateGroupMemberStatus(uniqueName: String, userId: Int32, status: GroupMemberStatusWrapper, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func updateGroupMemberStatusWithRequestBuilder(uniqueName: String, userId: Int32, status: GroupMemberStatusWrapper) -> RequestBuilder<Void> {
