...
class Decoders {
    ...
    private static var __once: () = {
        ...
        // Decoder for ActionContextobject
        Decoders.addDecoder(clazz: ActionContextobject.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<ActionContextobject> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                let result = instance == nil ? ActionContextobject() : instance as! ActionContextobject
                switch Decoders.decodeOptional(clazz: Any.self, source: sourceDictionary["mapping"] as AnyObject?) {
                
                case let .success(value): result.mapping = value
                case let .failure(error): return .failure(error)
                ...
                return .failure(.typeMismatch(expected: "ActionContextobject", actual: "\(source)"))
            }
        }
        ...
        // Decoder for ArgumentResource
        Decoders.addDecoder(clazz: ArgumentResource.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<ArgumentResource> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                let result = instance == nil ? ArgumentResource() : instance as! ArgumentResource
                switch Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["name"] as AnyObject?) {
                ...
                return .failure(.typeMismatch(expected: "ArgumentResource", actual: "\(source)"))
            }
        }
        ...
        Decoders.addDecoder(clazz: BreRule.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<BreRule> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                ...
                switch Decoders.decodeOptional(clazz: [ActionContextobject].self, source: sourceDictionary["actions"] as AnyObject?) {
                
                case let .success(value): result.actions = value
                case let .failure(error): return .failure(error)
                
                }
                switch Decoders.decodeOptional(clazz: PredicateResource.self, source: sourceDictionary["condition"] as AnyObject?) {
        ...
        Decoders.addDecoder(clazz: ConfigLookupResource.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<ConfigLookupResource> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                ...
                switch Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["definition"] as AnyObject?) {
                
                case let .success(value): result.definition = value
                case let .failure(error): return .failure(error)
                ...
                switch Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["required_key_type"] as AnyObject?) {
                
                case let .success(value): result.requiredKeyType = value
                case let .failure(error): return .failure(error)
        ...
        // Decoder for CreateActivityOccurrenceRequest
        Decoders.addDecoder(clazz: CreateActivityOccurrenceRequest.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<CreateActivityOccurrenceRequest> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                let result = instance == nil ? CreateActivityOccurrenceRequest() : instance as! CreateActivityOccurrenceRequest
                switch Decoders.decodeOptional(clazz: Int64.self, source: sourceDictionary["activity_id"] as AnyObject?) {
                ...
                switch Decoders.decodeOptional(clazz: CreateActivityOccurrenceRequest.Status.self, source: sourceDictionary["status"] as AnyObject?) {
                
                case let .success(value): result.status = value
                case let .failure(error): return .failure(error)
                
                }
                switch Decoders.decodeOptional(clazz: [Participant].self, source: sourceDictionary["users"] as AnyObject?) {
                ...
                return .failure(.typeMismatch(expected: "CreateActivityOccurrenceRequest", actual: "\(source)"))
            }
        }
        ...
        Decoders.addDecoder(clazz: DateOperationResource.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<DateOperationResource> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                ...
                switch Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["return_type"] as AnyObject?) {
                
                case let .success(value): result.returnType = value
                case let .failure(error): return .failure(error)
                
                }
                switch Decoders.decodeOptional(clazz: [OperationDefinitionResource].self, source: sourceDictionary["supported_operators"] as AnyObject?) {
                
                case let .success(value): result.supportedOperators = value
                case let .failure(error): return .failure(error)
        ...
        // Decoder for DefaultOperationResource
        Decoders.addDecoder(clazz: DefaultOperationResource.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<DefaultOperationResource> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                let result = instance == nil ? DefaultOperationResource() : instance as! DefaultOperationResource
                switch Decoders.decodeOptional(clazz: [ExpressionResource].self, source: sourceDictionary["args"] as AnyObject?) {
                ...
                return .failure(.typeMismatch(expected: "DefaultOperationResource", actual: "\(source)"))
            }
        }
        ...
        Decoders.addDecoder(clazz: DeviceResource.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<DeviceResource> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                // Check discriminator to support inheritance
                if let discriminator = sourceDictionary["device_type"] as? String, instance == nil && discriminator != "DeviceResource"{
                    return Decoders.decode(clazz: DeviceResource.self, discriminator: discriminator, source: source)
                }
                ...
                switch Decoders.decodeOptional(clazz: SimpleUserResource.self, source: sourceDictionary["owner"] as AnyObject?) {
        ...
        Decoders.addDecoder(clazz: GroupMemberResource.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<GroupMemberResource> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                ...
                case let .success(value): result.order = value
                case let .failure(error): return .failure(error)
        ...
        Decoders.addDecoder(clazz: IdRef.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<IdRef> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                let result = instance == nil ? IdRef() : instance as! IdRef
                switch Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["id"] as AnyObject?) {
                ...
                return .failure(.typeMismatch(expected: "IdRef", actual: "\(source)"))
            }
        }
        ...
        Decoders.addDecoder(clazz: InvoiceResource.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<InvoiceResource> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                ...
                switch Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["remaining_balance"] as AnyObject?) {
                
                case let .success(value): result.remainingBalance = value
                case let .failure(error): return .failure(error)
        ...
        // Decoder for ItemIdRequest
        Decoders.addDecoder(clazz: ItemIdRequest.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<ItemIdRequest> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                let result = instance == nil ? ItemIdRequest() : instance as! ItemIdRequest
                switch Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["item_id"] as AnyObject?) {
                ...
                return .failure(.typeMismatch(expected: "ItemIdRequest", actual: "\(source)"))
            }
        }
        ...
        Decoders.addDecoder(clazz: ItemTemplateResource.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<ItemTemplateResource> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                ...
                switch Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["allow_additional"] as AnyObject?) {
                
                case let .success(value): result.allowAdditional = value
                case let .failure(error): return .failure(error)
        ...
        Decoders.addDecoder(clazz: OAuth2Resource.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<OAuth2Resource> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                ...
                switch Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["refresh_token"] as AnyObject?) {
                
                case let .success(value): result.refreshToken = value
                case let .failure(error): return .failure(error)
        ...
        // Decoder for ObjectResource
        Decoders.addDecoder(clazz: ObjectResource.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<ObjectResource> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                let result = instance == nil ? ObjectResource() : instance as! ObjectResource
                switch Decoders.decodeOptional(clazz: [Behavior].self, source: sourceDictionary["behaviors"] as AnyObject?) {
                ...
                return .failure(.typeMismatch(expected: "ObjectResource", actual: "\(source)"))
            }
        }
        // Decoder for OperationDefinitionResource
        Decoders.addDecoder(clazz: OperationDefinitionResource.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<OperationDefinitionResource> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                let result = instance == nil ? OperationDefinitionResource() : instance as! OperationDefinitionResource
                switch Decoders.decodeOptional(clazz: [ArgumentResource].self, source: sourceDictionary["arguments"] as AnyObject?) {
                
                case let .success(value): result.arguments = value
                case let .failure(error): return .failure(error)
                ...
                return .failure(.typeMismatch(expected: "OperationDefinitionResource", actual: "\(source)"))
            }
        }
        // Decoder for OperationResource
        Decoders.addDecoder(clazz: OperationResource.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<OperationResource> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                let result = instance == nil ? OperationResource() : instance as! OperationResource
                switch Decoders.decodeOptional(clazz: [ExpressionResource].self, source: sourceDictionary["args"] as AnyObject?) {
                ...
                return .failure(.typeMismatch(expected: "OperationResource", actual: "\(source)"))
            }
        }
        ...
        // Decoder for PageResourceActivityOccurrenceResource
        Decoders.addDecoder(clazz: PageResourceActivityOccurrenceResource.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<PageResourceActivityOccurrenceResource> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                let result = instance == nil ? PageResourceActivityOccurrenceResource() : instance as! PageResourceActivityOccurrenceResource
                switch Decoders.decodeOptional(clazz: [ActivityOccurrenceResource].self, source: sourceDictionary["content"] as AnyObject?) {
                ...
                return .failure(.typeMismatch(expected: "PageResourceActivityOccurrenceResource", actual: "\(source)"))
            }
        }
        ...
        // Decoder for PageResourceFlagResource
        Decoders.addDecoder(clazz: PageResourceFlagResource.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<PageResourceFlagResource> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                let result = instance == nil ? PageResourceFlagResource() : instance as! PageResourceFlagResource
                switch Decoders.decodeOptional(clazz: [FlagResource].self, source: sourceDictionary["content"] as AnyObject?) {
                ...
                return .failure(.typeMismatch(expected: "PageResourceFlagResource", actual: "\(source)"))
            }
        }
        ...
        // Decoder for PageResourceObjectResource
        Decoders.addDecoder(clazz: PageResourceObjectResource.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<PageResourceObjectResource> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                let result = instance == nil ? PageResourceObjectResource() : instance as! PageResourceObjectResource
                switch Decoders.decodeOptional(clazz: [ObjectResource].self, source: sourceDictionary["content"] as AnyObject?) {
                ...
                return .failure(.typeMismatch(expected: "PageResourceObjectResource", actual: "\(source)"))
            }
        }
        // Decoder for PageResourcePaymentMethodTypeResource
        Decoders.addDecoder(clazz: PageResourcePaymentMethodTypeResource.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<PageResourcePaymentMethodTypeResource> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                let result = instance == nil ? PageResourcePaymentMethodTypeResource() : instance as! PageResourcePaymentMethodTypeResource
                switch Decoders.decodeOptional(clazz: [PaymentMethodTypeResource].self, source: sourceDictionary["content"] as AnyObject?) {
                ...
                return .failure(.typeMismatch(expected: "PageResourcePaymentMethodTypeResource", actual: "\(source)"))
            }
        }
        ...
        // Decoder for Participant
        Decoders.addDecoder(clazz: Participant.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<Participant> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                let result = instance == nil ? Participant() : instance as! Participant
                switch Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["host"] as AnyObject?) {
                ...
                switch Decoders.decodeOptional(clazz: Participant.Status.self, source: sourceDictionary["status"] as AnyObject?) {
                
                case let .success(value): result.status = value
                case let .failure(error): return .failure(error)
                
                }
                switch Decoders.decodeOptional(clazz: IdRef.self, source: sourceDictionary["user"] as AnyObject?) {
                ...
                return .failure(.typeMismatch(expected: "Participant", actual: "\(source)"))
            }
        }
        ...
        Decoders.addDecoder(clazz: PaymentMethodTypeResource.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<PaymentMethodTypeResource> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                ...
                switch Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["invoice_processing_hours"] as AnyObject?) {
                
                case let .success(value): result.invoiceProcessingHours = value
                case let .failure(error): return .failure(error)
                ...
                switch Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["supports_capture"] as AnyObject?) {
                
                case let .success(value): result.supportsCapture = value
                case let .failure(error): return .failure(error)
                
                }
                switch Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["supports_partial"] as AnyObject?) {
                
                case let .success(value): result.supportsPartial = value
                case let .failure(error): return .failure(error)
                
                }
                switch Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["supports_rebill"] as AnyObject?) {
                
                case let .success(value): result.supportsRebill = value
                case let .failure(error): return .failure(error)
                
                }
                switch Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["supports_refunds"] as AnyObject?) {
                
                case let .success(value): result.supportsRefunds = value
                case let .failure(error): return .failure(error)
        ...
        // Decoder for RawPushResource
        Decoders.addDecoder(clazz: RawPushResource.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<RawPushResource> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                let result = instance == nil ? RawPushResource() : instance as! RawPushResource
                switch Decoders.decodeOptional(clazz: [Int32].self, source: sourceDictionary["recipients"] as AnyObject?) {
                ...
                return .failure(.typeMismatch(expected: "RawPushResource", actual: "\(source)"))
            }
        }
        ...
        // Decoder for SelectedSettingRequest
        Decoders.addDecoder(clazz: SelectedSettingRequest.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<SelectedSettingRequest> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                let result = instance == nil ? SelectedSettingRequest() : instance as! SelectedSettingRequest
                switch Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["key"] as AnyObject?) {
                ...
                return .failure(.typeMismatch(expected: "SelectedSettingRequest", actual: "\(source)"))
            }
        }
        ...
        Decoders.addDecoder(clazz: Sku.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<Sku> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                ...
                switch Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["not_available"] as AnyObject?) {
                
                case let .success(value): result.notAvailable = value
                case let .failure(error): return .failure(error)
                
                }
                switch Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["not_displayable"] as AnyObject?) {
                
                case let .success(value): result.notDisplayable = value
                case let .failure(error): return .failure(error)
        ...
        // Decoder for TemplatePushResource
        Decoders.addDecoder(clazz: TemplatePushResource.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<TemplatePushResource> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                let result = instance == nil ? TemplatePushResource() : instance as! TemplatePushResource
                switch Decoders.decodeOptional(clazz: [Int32].self, source: sourceDictionary["recipients"] as AnyObject?) {
                ...
                switch Decoders.decodeOptional(clazz: Any.self, source: sourceDictionary["template_vars"] as AnyObject?) {
                ...
                return .failure(.typeMismatch(expected: "TemplatePushResource", actual: "\(source)"))
            }
        }
        ...
        // Decoder for ListProperty
        Decoders.addDecoder(clazz: ListProperty.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<ListProperty> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                let result = instance == nil ? ListProperty() : instance as! ListProperty
                if decoders["\(Property.self)"] != nil {
                  _ = Decoders.decode(clazz: Property.self, source: source, instance: result)
                }
                switch Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["type"] as AnyObject?) {
                ...
                switch Decoders.decodeOptional(clazz: [Property].self, source: sourceDictionary["values"] as AnyObject?) {
                
                case let .success(value): result.values = value
                case let .failure(error): return .failure(error)
                
                }
                return .success(result)
            } else {
                return .failure(.typeMismatch(expected: "ListProperty", actual: "\(source)"))
            }
        }
        // Decoder for ListPropertyDefinitionResource
        Decoders.addDecoder(clazz: ListPropertyDefinitionResource.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<ListPropertyDefinitionResource> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                let result = instance == nil ? ListPropertyDefinitionResource() : instance as! ListPropertyDefinitionResource
                if decoders["\(PropertyDefinitionResource.self)"] != nil {
                  _ = Decoders.decode(clazz: PropertyDefinitionResource.self, source: source, instance: result)
                }
                switch Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["description"] as AnyObject?) {
                ...
                switch Decoders.decodeOptional(clazz: PropertyDefinitionResource.self, source: sourceDictionary["value_definition"] as AnyObject?) {
                
                case let .success(value): result.valueDefinition = value
                case let .failure(error): return .failure(error)
                
                }
                return .success(result)
            } else {
                return .failure(.typeMismatch(expected: "ListPropertyDefinitionResource", actual: "\(source)"))
            }
        }
        ...
        // Decoder for MapProperty
        Decoders.addDecoder(clazz: MapProperty.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<MapProperty> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                let result = instance == nil ? MapProperty() : instance as! MapProperty
                if decoders["\(Property.self)"] != nil {
                  _ = Decoders.decode(clazz: Property.self, source: source, instance: result)
                }
                switch Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["type"] as AnyObject?) {
                ...
                switch Decoders.decodeOptional(clazz: [String:Property].self, source: sourceDictionary["map"] as AnyObject?) {
                ...
                return .failure(.typeMismatch(expected: "MapProperty", actual: "\(source)"))
            }
        }
        // Decoder for MapPropertyDefinitionResource
        Decoders.addDecoder(clazz: MapPropertyDefinitionResource.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<MapPropertyDefinitionResource> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                let result = instance == nil ? MapPropertyDefinitionResource() : instance as! MapPropertyDefinitionResource
                if decoders["\(PropertyDefinitionResource.self)"] != nil {
                  _ = Decoders.decode(clazz: PropertyDefinitionResource.self, source: source, instance: result)
                }
                switch Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["description"] as AnyObject?) {
                ...
                return .failure(.typeMismatch(expected: "MapPropertyDefinitionResource", actual: "\(source)"))
            }
        }
        // Decoder for MobileDeviceResource
        Decoders.addDecoder(clazz: MobileDeviceResource.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<MobileDeviceResource> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                let result = instance == nil ? MobileDeviceResource() : instance as! MobileDeviceResource
                if decoders["\(DeviceResource.self)"] != nil {
                  _ = Decoders.decode(clazz: DeviceResource.self, source: source, instance: result)
                }
                switch Decoders.decodeOptional(clazz: [String:Property].self, source: sourceDictionary["additional_properties"] as AnyObject?) {
                ...
                switch Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["imei"] as AnyObject?) {
                
                case let .success(value): result.imei = value
                case let .failure(error): return .failure(error)
                
                }
                switch Decoders.decodeOptional(clazz: MobileDeviceResource.NotificationPlatform.self, source: sourceDictionary["notification_platform"] as AnyObject?) {
                
                case let .success(value): result.notificationPlatform = value
                case let .failure(error): return .failure(error)
                
                }
                switch Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["number"] as AnyObject?) {
                ...
                return .failure(.typeMismatch(expected: "MobileDeviceResource", actual: "\(source)"))
            }
        }
        ...
        Decoders.addDecoder(clazz: PriceOverridable.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<PriceOverridable> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                ...
                switch Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["max_price"] as AnyObject?) {
                
                case let .success(value): result.maxPrice = value
                case let .failure(error): return .failure(error)
                
                }
                switch Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["min_price"] as AnyObject?) {
