//
// PageResourceActivityOccurrenceResource.swift
//
...
open class PageResourceActivityOccurrenceResource: JSONEncodable {

    public var content: [ActivityOccurrenceResource]?
