//
// PageResourceAchievementDefinitionResource.swift
//
...
open class PageResourceAchievementDefinitionResource: JSONEncodable {

    public var content: [AchievementDefinitionResource]?
