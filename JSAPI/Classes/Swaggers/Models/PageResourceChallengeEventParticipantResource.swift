//
// PageResourceChallengeEventParticipantResource.swift
//
...
open class PageResourceChallengeEventParticipantResource: JSONEncodable {

    public var content: [ChallengeEventParticipantResource]?
