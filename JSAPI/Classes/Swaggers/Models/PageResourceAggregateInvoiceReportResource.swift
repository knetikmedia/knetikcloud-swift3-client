//
// PageResourceAggregateInvoiceReportResource.swift
//
...
open class PageResourceAggregateInvoiceReportResource: JSONEncodable {

    public var content: [AggregateInvoiceReportResource]?
