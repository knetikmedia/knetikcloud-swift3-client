//
// PageResourceSimpleReferenceResourceobject.swift
//
...
open class PageResourceSimpleReferenceResourceobject: JSONEncodable {

    public var content: [SimpleReferenceResourceobject]?
