//
// PageResourceRevenueProductReportResource.swift
//
...
open class PageResourceRevenueProductReportResource: JSONEncodable {

    public var content: [RevenueProductReportResource]?
