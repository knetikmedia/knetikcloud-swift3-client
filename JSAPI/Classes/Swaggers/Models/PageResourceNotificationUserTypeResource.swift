//
// PageResourceNotificationUserTypeResource.swift
//
...
open class PageResourceNotificationUserTypeResource: JSONEncodable {

    public var content: [NotificationUserTypeResource]?
