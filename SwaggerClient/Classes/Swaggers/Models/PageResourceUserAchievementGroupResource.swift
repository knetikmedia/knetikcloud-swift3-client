//
// PageResourceUserAchievementGroupResource.swift
//
...
open class PageResourceUserAchievementGroupResource: JSONEncodable {
    public var content: [UserAchievementGroupResource]?
