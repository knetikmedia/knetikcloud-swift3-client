//
// PageResourceBareChallengeActivityResource.swift
//
...
open class PageResourceBareChallengeActivityResource: JSONEncodable {
    public var content: [BareChallengeActivityResource]?
