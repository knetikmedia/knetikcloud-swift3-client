//
// PageResourceSubscriptionTemplateResource.swift
//
...
open class PageResourceSubscriptionTemplateResource: JSONEncodable {
    public var content: [SubscriptionTemplateResource]?
