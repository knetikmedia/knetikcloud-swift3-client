//
// PageResourceRevenueCountryReportResource.swift
//
...
open class PageResourceRevenueCountryReportResource: JSONEncodable {
    public var content: [RevenueCountryReportResource]?
