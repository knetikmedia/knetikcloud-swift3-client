...
open class User: JSONEncodable {
    ...
    public var children: [UserRelationship]?
    ...
    public var parents: [UserRelationship]?
    ...
    open func encodeToJSON() -> Any {
        ...
        nillableDictionary["tag_strings"] = self.tagStrings?.encodeToJSON()
