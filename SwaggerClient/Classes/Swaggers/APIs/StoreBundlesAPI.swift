...
open class StoreBundlesAPI: APIBase {
  ...
  "skus" : [ {
    "sale_id" : 5,
    "original_price" : 6.160730408635877,
    "description" : "aeiou",
    "stop_date" : 4,
    "published" : false,
    "inventory" : 8,
  ...
  "bundled_skus" : [ {
    "quantity" : 0,
    "price_override" : 5.727244517999703,
    "sku" : "aeiou"
  } ],
  ...
  "skus" : [ {
    "sale_id" : 0,
    "original_price" : 3.967548483475661,
    "description" : "aeiou",
    "stop_date" : 5,
    "published" : false,
    "inventory" : 5,
  ...
  "bundled_skus" : [ {
    "quantity" : 0,
    "price_override" : 6.237251233949222,
    "sku" : "aeiou"
  } ],
  "long_description" : "aeiou",
  "sort" : 4,
  ...
  "skus" : [ {
    "sale_id" : 2,
    "original_price" : 6.105249512255414,
    "description" : "aeiou",
    "stop_date" : 4,
    "published" : false,
    "inventory" : 5,
  ...
  "bundled_skus" : [ {
    "quantity" : 4,
    "price_override" : 0.11863453413317626,
    "sku" : "aeiou"
  } ],
  "long_description" : "aeiou",
  "sort" : 4,
