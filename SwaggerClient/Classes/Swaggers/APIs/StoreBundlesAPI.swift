...
open class StoreBundlesAPI: APIBase {
  ...
  "skus" : [ {
    "sale_id" : 9,
    "original_price" : 9.183493609354228,
    "description" : "aeiou",
    "stop_date" : 3,
    "published" : false,
    "inventory" : 4,
  ...
  "bundled_skus" : [ {
    "quantity" : 9,
    "price_override" : 6.77110751963159,
    "sku" : "aeiou"
  } ],
  ...
  "skus" : [ {
    "sale_id" : 9,
    "original_price" : 4.190600751001261,
    "description" : "aeiou",
    "stop_date" : 6,
    "published" : false,
    "inventory" : 3,
  ...
  "bundled_skus" : [ {
    "quantity" : 8,
    "price_override" : 7.056215640985797,
    "sku" : "aeiou"
  } ],
  "long_description" : "aeiou",
  "sort" : 0,
  ...
  "skus" : [ {
    "sale_id" : 7,
    "original_price" : 3.2084144530398273,
    "description" : "aeiou",
    "stop_date" : 6,
    "published" : false,
    "inventory" : 4,
  ...
  "bundled_skus" : [ {
    "quantity" : 5,
    "price_override" : 0.9291480153440068,
    "sku" : "aeiou"
  } ],
  "long_description" : "aeiou",
  "sort" : 8,
