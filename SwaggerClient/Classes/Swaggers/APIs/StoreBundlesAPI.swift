...
open class StoreBundlesAPI: APIBase {
     ...
     */
    open class func createBundleItem(bundleItem: BundleItem? = nil, completion: @escaping ((_ data: BundleItem?,_ error: Error?) -> Void)) {
        createBundleItemWithRequestBuilder(bundleItem: bundleItem).execute { (response, error) -> Void in
  ...
  "category" : "aeiou"
     ...
     */
    open class func createBundleItemWithRequestBuilder(bundleItem: BundleItem? = nil) -> RequestBuilder<BundleItem> {
  ...
  "first" : true
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func updateBundleItem(id: Int32, bundleItem: BundleItem? = nil, completion: @escaping ((_ error: Error?) -> Void)) {
        updateBundleItemWithRequestBuilder(id: id, bundleItem: bundleItem).execute { (response, error) -> Void in
            completion(error);
        }
    }
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func updateBundleItemWithRequestBuilder(id: Int32, bundleItem: BundleItem? = nil) -> RequestBuilder<Void> {
        var path = "/store/bundles/{id}"
        path = path.replacingOccurrences(of: "{id}", with: "\(id)", options: .literal, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
        let parameters = bundleItem?.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func updateBundleTemplate(id: String, bundleTemplateResource: ItemTemplateResource? = nil, completion: @escaping ((_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func updateBundleTemplateWithRequestBuilder(id: String, bundleTemplateResource: ItemTemplateResource? = nil) -> RequestBuilder<Void> {
        var path = "/store/bundles/templates/{id}"
        path = path.replacingOccurrences(of: "{id}", with: "\(id)", options: .literal, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
        let parameters = bundleTemplateResource?.encodeToJSON() as? [String:AnyObject]
