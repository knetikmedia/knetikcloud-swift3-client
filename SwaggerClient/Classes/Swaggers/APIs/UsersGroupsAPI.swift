...
open class UsersGroupsAPI: APIBase {
  ...
  "properties" : [ {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func deleteGroupMemberUsingDELETE(uniqueName: String, userId: Int32, completion: @escaping ((_ error: Error?) -> Void)) {
     ...
     */
    open class func deleteGroupMemberUsingDELETEWithRequestBuilder(uniqueName: String, userId: Int32) -> RequestBuilder<Void> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func deleteGroupUsingDELETE(uniqueName: String, completion: @escaping ((_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func deleteGroupUsingDELETEWithRequestBuilder(uniqueName: String) -> RequestBuilder<Void> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getGroupListUsingGET(userId: Int32, completion: @escaping ((_ data: [String]?,_ error: Error?) -> Void)) {
     ...
     */
    open class func getGroupListUsingGETWithRequestBuilder(userId: Int32) -> RequestBuilder<[String]> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getGroupMemberUsingGET(uniqueName: String, userId: Int32, completion: @escaping ((_ data: GroupMemberResource?,_ error: Error?) -> Void)) {
  ...
  "username" : "aeiou"
     ...
     - returns: RequestBuilder<GroupMemberResource> 
     */
    open class func getGroupMemberUsingGETWithRequestBuilder(uniqueName: String, userId: Int32) -> RequestBuilder<GroupMemberResource> {
        var path = "/users/groups/{uniqueName}/members/{userId}"
        path = path.replacingOccurrences(of: "{uniqueName}", with: "\(uniqueName)", options: .literal, range: nil)
        path = path.replacingOccurrences(of: "{userId}", with: "\(userId)", options: .literal, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
