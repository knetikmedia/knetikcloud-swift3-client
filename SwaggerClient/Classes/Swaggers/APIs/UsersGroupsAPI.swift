...
open class UsersGroupsAPI: APIBase {
  ...
  "properties" : [ {
    ...
    /**
     ...
     - parameter filterName: (query) Filter for groups whose name starts with provided string (optional)
     - parameter filterUniqueName: (query) Filter for groups whose unique_name starts with provided string (optional)
     - parameter filterParent: (query) Filter for groups whose parent equals provided string (optional)
     - parameter size: (query) The number of objects returned per page (optional, default to 25)
     - parameter page: (query) The number of the page returned, starting with 1 (optional, default to 1)
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func updateGroups(filterName: String? = nil, filterUniqueName: String? = nil, filterParent: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: @escaping ((_ data: PageResourceGroupResource?,_ error: Error?) -> Void)) {
        updateGroupsWithRequestBuilder(filterName: filterName, filterUniqueName: filterUniqueName, filterParent: filterParent, size: size, page: page, order: order).execute { (response, error) -> Void in
            completion(response?.body, error);
        }
    }
  ...
  "first" : true
     ...
     */
    open class func updateGroupsWithRequestBuilder(filterName: String? = nil, filterUniqueName: String? = nil, filterParent: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageResourceGroupResource> {
        let path = "/users/groups"
        let URLString = SwaggerClientAPI.basePath + path
        let parameters: [String:Any]? = nil
