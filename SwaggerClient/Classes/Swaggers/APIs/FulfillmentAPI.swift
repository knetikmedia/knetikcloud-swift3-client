...
open class FulfillmentAPI: APIBase {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getFulfillmentsUsingGET(size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: @escaping ((_ data: PageFulfillmentType?,_ error: Error?) -> Void)) {
     ...
     */
    open class func getFulfillmentsUsingGETWithRequestBuilder(size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageFulfillmentType> {
        let path = "/store/fulfillment/types"
        let URLString = SwaggerClientAPI.basePath + path
