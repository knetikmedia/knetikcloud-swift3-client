...
open class GamificationAchievementsAPI: APIBase {
  ...
  "id" : "aeiou"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getUserAchievementsProgress(userId: Int32, filterAchievementDerived: Bool? = nil, filterAchievementTagset: String? = nil, filterAchievementName: String? = nil, filterAchievementHidden: Bool? = nil, size: Int32? = nil, page: Int32? = nil, completion: @escaping ((_ data: PageResourceUserAchievementGroupResource?,_ error: Error?) -> Void)) {
        getUserAchievementsProgressWithRequestBuilder(userId: userId, filterAchievementDerived: filterAchievementDerived, filterAchievementTagset: filterAchievementTagset, filterAchievementName: filterAchievementName, filterAchievementHidden: filterAchievementHidden, size: size, page: page).execute { (response, error) -> Void in
            completion(response?.body, error);
        }
    }
  ...
  "first" : true
     ...
     */
    open class func getUserAchievementsProgressWithRequestBuilder(userId: Int32, filterAchievementDerived: Bool? = nil, filterAchievementTagset: String? = nil, filterAchievementName: String? = nil, filterAchievementHidden: Bool? = nil, size: Int32? = nil, page: Int32? = nil) -> RequestBuilder<PageResourceUserAchievementGroupResource> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getUsersAchievementProgress(achievementName: String, filterAchievementDerived: Bool? = nil, filterAchievementTagset: String? = nil, filterAchievementHidden: Bool? = nil, size: Int32? = nil, page: Int32? = nil, completion: @escaping ((_ data: PageResourceUserAchievementGroupResource?,_ error: Error?) -> Void)) {
        getUsersAchievementProgressWithRequestBuilder(achievementName: achievementName, filterAchievementDerived: filterAchievementDerived, filterAchievementTagset: filterAchievementTagset, filterAchievementHidden: filterAchievementHidden, size: size, page: page).execute { (response, error) -> Void in
            completion(response?.body, error);
        }
    }
  ...
  "first" : true
     ...
     - returns: RequestBuilder<PageResourceUserAchievementGroupResource> 
     */
    open class func getUsersAchievementProgressWithRequestBuilder(achievementName: String, filterAchievementDerived: Bool? = nil, filterAchievementTagset: String? = nil, filterAchievementHidden: Bool? = nil, size: Int32? = nil, page: Int32? = nil) -> RequestBuilder<PageResourceUserAchievementGroupResource> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getUsersAchievementsProgress(filterAchievementDerived: Bool? = nil, filterAchievementTagset: String? = nil, filterAchievementName: String? = nil, filterAchievementHidden: Bool? = nil, size: Int32? = nil, page: Int32? = nil, completion: @escaping ((_ data: PageResourceUserAchievementGroupResource?,_ error: Error?) -> Void)) {
        getUsersAchievementsProgressWithRequestBuilder(filterAchievementDerived: filterAchievementDerived, filterAchievementTagset: filterAchievementTagset, filterAchievementName: filterAchievementName, filterAchievementHidden: filterAchievementHidden, size: size, page: page).execute { (response, error) -> Void in
            completion(response?.body, error);
        }
    }
  ...
  "first" : true
     ...
     - returns: RequestBuilder<PageResourceUserAchievementGroupResource> 
     */
    open class func getUsersAchievementsProgressWithRequestBuilder(filterAchievementDerived: Bool? = nil, filterAchievementTagset: String? = nil, filterAchievementName: String? = nil, filterAchievementHidden: Bool? = nil, size: Int32? = nil, page: Int32? = nil) -> RequestBuilder<PageResourceUserAchievementGroupResource> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func updateAchievement(name: String, achievement: AchievementDefinitionResource? = nil, completion: @escaping ((_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func updateAchievementWithRequestBuilder(name: String, achievement: AchievementDefinitionResource? = nil) -> RequestBuilder<Void> {
        var path = "/achievements/{name}"
        path = path.replacingOccurrences(of: "{name}", with: "\(name)", options: .literal, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
        let parameters = achievement?.encodeToJSON() as? [String:AnyObject]
  ...
  "id" : "aeiou"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func updateAchievementTemplate(id: String, template: TemplateResource? = nil, completion: @escaping ((_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func updateAchievementTemplateWithRequestBuilder(id: String, template: TemplateResource? = nil) -> RequestBuilder<Void> {
        var path = "/achievements/templates/{id}"
        path = path.replacingOccurrences(of: "{id}", with: "\(id)", options: .literal, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
        let parameters = template?.encodeToJSON() as? [String:AnyObject]
