...
open class AuthRolesAPI: APIBase {
  ...
  "client_count" : 123
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getRolesUsingGET(size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: @escaping ((_ data: PageRoleResource?,_ error: Error?) -> Void)) {
  ...
  "first" : true
     ...
     */
    open class func getRolesUsingGETWithRequestBuilder(size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageRoleResource> {
        let path = "/auth/roles"
        let URLString = SwaggerClientAPI.basePath + path
