...
open class AuthRolesAPI: APIBase {
  ...
  "client_count" : 123
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func setClientRoles(clientKey: String, rolesList: [String]? = nil, completion: @escaping ((_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func setClientRolesWithRequestBuilder(clientKey: String, rolesList: [String]? = nil) -> RequestBuilder<Void> {
        var path = "/auth/clients/{clientKey}/roles"
        path = path.replacingOccurrences(of: "{clientKey}", with: "\(clientKey)", options: .literal, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func setPermissionsForRole(role: String, permissionsList: [String]? = nil, completion: @escaping ((_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func setPermissionsForRoleWithRequestBuilder(role: String, permissionsList: [String]? = nil) -> RequestBuilder<Void> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func setUserRoles(userId: Int32, rolesList: [String]? = nil, completion: @escaping ((_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func setUserRolesWithRequestBuilder(userId: Int32, rolesList: [String]? = nil) -> RequestBuilder<Void> {
        var path = "/auth/users/{userId}/roles"
        path = path.replacingOccurrences(of: "{userId}", with: "\(userId)", options: .literal, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
        let parameters = rolesList?.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func updateRole(role: String, roleResource: RoleResource? = nil, completion: @escaping ((_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func updateRoleWithRequestBuilder(role: String, roleResource: RoleResource? = nil) -> RequestBuilder<Void> {
        var path = "/auth/roles/{role}"
        path = path.replacingOccurrences(of: "{role}", with: "\(role)", options: .literal, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
        let parameters = roleResource?.encodeToJSON() as? [String:AnyObject]
