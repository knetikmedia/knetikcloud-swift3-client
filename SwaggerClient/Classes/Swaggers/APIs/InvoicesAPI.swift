...
open class InvoicesAPI: APIBase {
  ...
  "shipping_postal_code" : "aeiou"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getLogsUsingGET(id: Int32, size: Int32? = nil, page: Int32? = nil, completion: @escaping ((_ data: PageResourceInvoiceLogEntry?,_ error: Error?) -> Void)) {
  ...
  "first" : true
     ...
     */
    open class func getLogsUsingGETWithRequestBuilder(id: Int32, size: Int32? = nil, page: Int32? = nil) -> RequestBuilder<PageResourceInvoiceLogEntry> {
