...
open class InvoicesAPI: APIBase {
  ...
  "first" : true
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getInvoiceUsingGET(id: Int32, completion: @escaping ((_ data: InvoiceResource?,_ error: Error?) -> Void)) {
        getInvoiceUsingGETWithRequestBuilder(id: id).execute { (response, error) -> Void in
            completion(response?.body, error);
        }
    }
  ...
  "shipping_postal_code" : "aeiou"
     ...
     - returns: RequestBuilder<InvoiceResource> 
     */
    open class func getInvoiceUsingGETWithRequestBuilder(id: Int32) -> RequestBuilder<InvoiceResource> {
