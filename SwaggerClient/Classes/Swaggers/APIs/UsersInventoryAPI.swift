...
open class UsersInventoryAPI: APIBase {
  ...
  "first" : true
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getUserInventories(id: Int32, inactive: Bool? = nil, size: Int32? = nil, page: Int32? = nil, filterItemName: String? = nil, filterMinDate: Int64? = nil, filterMaxDate: Int64? = nil, completion: @escaping ((_ data: PageResourceUserInventoryResource?,_ error: Error?) -> Void)) {
  ...
  "first" : true
     ...
     */
    open class func getUserInventoriesWithRequestBuilder(id: Int32, inactive: Bool? = nil, size: Int32? = nil, page: Int32? = nil, filterItemName: String? = nil, filterMinDate: Int64? = nil, filterMaxDate: Int64? = nil) -> RequestBuilder<PageResourceUserInventoryResource> {
        var path = "/users/{id}/inventory"
        path = path.replacingOccurrences(of: "{id}", with: "\(id)", options: .literal, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
        let parameters: [String:Any]? = nil
