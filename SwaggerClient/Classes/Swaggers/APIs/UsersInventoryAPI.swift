...
open class UsersInventoryAPI: APIBase {
  ...
  "shipping_postal_code" : "aeiou"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func createEntitlementItem(entitlementItem: EntitlementItem? = nil, completion: @escaping ((_ data: EntitlementItem?,_ error: Error?) -> Void)) {
  ...
  "category" : "aeiou"
     ...
     */
    open class func createEntitlementItemWithRequestBuilder(entitlementItem: EntitlementItem? = nil) -> RequestBuilder<EntitlementItem> {
  ...
  "status" : "aeiou"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getUserInventory1(id: Int32, inactive: Bool? = nil, size: Int32? = nil, page: Int32? = nil, filterItemName: String? = nil, filterMinDate: Int64? = nil, filterMaxDate: Int64? = nil, completion: @escaping ((_ data: PageResourceUserInventoryResource?,_ error: Error?) -> Void)) {
        getUserInventory1WithRequestBuilder(id: id, inactive: inactive, size: size, page: page, filterItemName: filterItemName, filterMinDate: filterMinDate, filterMaxDate: filterMaxDate).execute { (response, error) -> Void in
            completion(response?.body, error);
        }
    }
  ...
  "first" : true
     ...
     */
    open class func getUserInventory1WithRequestBuilder(id: Int32, inactive: Bool? = nil, size: Int32? = nil, page: Int32? = nil, filterItemName: String? = nil, filterMinDate: Int64? = nil, filterMaxDate: Int64? = nil) -> RequestBuilder<PageResourceUserInventoryResource> {
        var path = "/users/{id}/inventory"
        path = path.replacingOccurrences(of: "{id}", with: "\(id)", options: .literal, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
        let parameters: [String:Any]? = nil
  ...
  "first" : true
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getUserInventoryLog1(userId: Int32, id: Int32, timestamp: Int64? = nil, completion: @escaping ((_ error: Error?) -> Void)) {
        getUserInventoryLog1WithRequestBuilder(userId: userId, id: id, timestamp: timestamp).execute { (response, error) -> Void in
            completion(error);
        }
    }
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func getUserInventoryLog1WithRequestBuilder(userId: Int32, id: Int32, timestamp: Int64? = nil) -> RequestBuilder<Void> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getUsersInventory(inactive: Bool? = nil, size: Int32? = nil, page: Int32? = nil, filterItemName: String? = nil, filterUsername: String? = nil, filterGroup: String? = nil, filterDate: String? = nil, completion: @escaping ((_ data: PageResourceUserInventoryResource?,_ error: Error?) -> Void)) {
  ...
  "first" : true
     ...
     - returns: RequestBuilder<PageResourceUserInventoryResource> 
     */
    open class func getUsersInventoryWithRequestBuilder(inactive: Bool? = nil, size: Int32? = nil, page: Int32? = nil, filterItemName: String? = nil, filterUsername: String? = nil, filterGroup: String? = nil, filterDate: String? = nil) -> RequestBuilder<PageResourceUserInventoryResource> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func updateEntitlementItem(entitlementId: Int32, entitlementItem: EntitlementItem? = nil, completion: @escaping ((_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func updateEntitlementItemWithRequestBuilder(entitlementId: Int32, entitlementItem: EntitlementItem? = nil) -> RequestBuilder<Void> {
        var path = "/entitlements/{entitlementId}"
        path = path.replacingOccurrences(of: "{entitlementId}", with: "\(entitlementId)", options: .literal, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
        let parameters = entitlementItem?.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func updateEntitlementTemplate(id: String, template: ItemTemplateResource? = nil, completion: @escaping ((_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func updateEntitlementTemplateWithRequestBuilder(id: String, template: ItemTemplateResource? = nil) -> RequestBuilder<Void> {
        var path = "/entitlements/templates/{id}"
        path = path.replacingOccurrences(of: "{id}", with: "\(id)", options: .literal, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
        let parameters = template?.encodeToJSON() as? [String:AnyObject]
