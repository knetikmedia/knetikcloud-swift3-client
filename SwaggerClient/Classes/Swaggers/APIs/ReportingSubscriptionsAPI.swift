...
open class ReportingSubscriptionsAPI: APIBase {
     ...
     */
    open class func listBillingReportsUsingGET(size: Int32? = nil, page: Int32? = nil, completion: @escaping ((_ data: PageResourceBillingReport?,_ error: Error?) -> Void)) {
  ...
  "first" : true
     ...
     */
    open class func listBillingReportsUsingGETWithRequestBuilder(size: Int32? = nil, page: Int32? = nil) -> RequestBuilder<PageResourceBillingReport> {
