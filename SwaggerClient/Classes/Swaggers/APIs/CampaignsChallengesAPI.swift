...
open class CampaignsChallengesAPI: APIBase {
  ...
  "start_date" : 123456789
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func updateChallengeActivity(activityId: Int64, challengeId: Int64, challengeActivityResource: ChallengeActivityResource? = nil, completion: @escaping ((_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func updateChallengeActivityWithRequestBuilder(activityId: Int64, challengeId: Int64, challengeActivityResource: ChallengeActivityResource? = nil) -> RequestBuilder<Void> {
        var path = "/challenges/{challengeId}/activities/{activityId}"
        path = path.replacingOccurrences(of: "{activityId}", with: "\(activityId)", options: .literal, range: nil)
        path = path.replacingOccurrences(of: "{challengeId}", with: "\(challengeId)", options: .literal, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func updateChallengeTemplate(id: String, challengeTemplateResource: TemplateResource? = nil, completion: @escaping ((_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func updateChallengeTemplateWithRequestBuilder(id: String, challengeTemplateResource: TemplateResource? = nil) -> RequestBuilder<Void> {
        var path = "/challenges/templates/{id}"
        path = path.replacingOccurrences(of: "{id}", with: "\(id)", options: .literal, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
        let parameters = challengeTemplateResource?.encodeToJSON() as? [String:AnyObject]
