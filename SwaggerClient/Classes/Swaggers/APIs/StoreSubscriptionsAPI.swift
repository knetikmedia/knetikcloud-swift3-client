...
open class StoreSubscriptionsAPI: APIBase {
  ...
  "plans" : [ {
    "end_date" : 3,
    "initial_fee" : 2.9452606094217804,
    "late_payment_fee" : 0.2961865551883902,
    "billing_cycle_length" : 5,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 3.57253563975904,
    "min_cycles" : 9,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 5,
    ...
    "reactivation_fee" : 9.648644258723468,
    "max_cycles" : 6
  } ],
  "store_start" : 5,
  "vendor_id" : 2,
  ...
  "plans" : [ {
    "end_date" : 3,
    "initial_fee" : 7.0849569999579955,
    "late_payment_fee" : 3.9893969371938356,
    "billing_cycle_length" : 3,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 7.4815849618434545,
    "min_cycles" : 2,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 6,
    "additional_properties" : {
    ...
    "name" : "aeiou",
    "billing_cycle_unit" : "millisecond",
    "reactivation_fee" : 6.317522346042971,
    "max_cycles" : 8
  } ],
  "store_start" : 4,
  "vendor_id" : 6,
  ...
  "content" : [ {
    ...
    "plans" : [ {
      "end_date" : 7,
      "initial_fee" : 1.6802125133598056,
      "late_payment_fee" : 6.107901681765066,
      "billing_cycle_length" : 9,
      "reactivation_sku" : "aeiou",
      "currency_code" : "aeiou",
      "recurring_fee" : 3.4622560938230116,
      "min_cycles" : 5,
      "recurring_sku" : "aeiou",
      "max_bill_attempts" : 5,
      "additional_properties" : {
      ...
      "name" : "aeiou",
      "billing_cycle_unit" : "millisecond",
      "reactivation_fee" : 7.437404209068223,
      "max_cycles" : 6
    } ],
    "store_start" : 7,
    "vendor_id" : 6,
