...
open class StoreSubscriptionsAPI: APIBase {
  ...
  "plans" : [ {
    "end_date" : 1,
    "initial_fee" : 7.745480725532509,
    "late_payment_fee" : 0.3003333976602718,
    "billing_cycle_length" : 7,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 7.966095346237631,
    "min_cycles" : 6,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 1,
    ...
    "reactivation_fee" : 9.29781269993661,
    "max_cycles" : 4
  } ],
  "store_start" : 5,
  "vendor_id" : 6,
  ...
  "plans" : [ {
    "end_date" : 0,
    "initial_fee" : 3.789577718332903,
    "late_payment_fee" : 2.0726135789677915,
    "billing_cycle_length" : 1,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 6.817402545839312,
    "min_cycles" : 8,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 1,
    "additional_properties" : {
    ...
    "name" : "aeiou",
    "billing_cycle_unit" : "millisecond",
    "reactivation_fee" : 7.991798928018772,
    "max_cycles" : 2
  } ],
  "store_start" : 3,
  "vendor_id" : 3,
  ...
  "content" : [ {
    ...
    "plans" : [ {
      "end_date" : 7,
      "initial_fee" : 6.609639781946801,
      "late_payment_fee" : 8.1979233585738,
      "billing_cycle_length" : 3,
      "reactivation_sku" : "aeiou",
      "currency_code" : "aeiou",
      "recurring_fee" : 3.0448106472440806,
      "min_cycles" : 1,
      "recurring_sku" : "aeiou",
      "max_bill_attempts" : 1,
      "additional_properties" : {
      ...
      "name" : "aeiou",
      "billing_cycle_unit" : "millisecond",
      "reactivation_fee" : 8.022815131302556,
      "max_cycles" : 7
    } ],
    "store_start" : 9,
    "vendor_id" : 6,
