...
open class StoreSubscriptionsAPI: APIBase {
  ...
  "plans" : [ {
    "end_date" : 1,
    "initial_fee" : 8.407931999606934,
    "late_payment_fee" : 4.979972886920844,
    "billing_cycle_length" : 1,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 9.47484836111919,
    "min_cycles" : 6,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 3,
    ...
    "reactivation_fee" : 5.367163070221739,
    "max_cycles" : 0
  } ],
  "store_start" : 9,
  "vendor_id" : 9,
  ...
  "plans" : [ {
    "end_date" : 3,
    "initial_fee" : 1.9390131017976198,
    "late_payment_fee" : 9.520111884783532,
    "billing_cycle_length" : 9,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 7.938684647386713,
    "min_cycles" : 7,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 8,
    "additional_properties" : {
    ...
    "name" : "aeiou",
    "billing_cycle_unit" : "millisecond",
    "reactivation_fee" : 5.001526552114858,
    "max_cycles" : 9
  } ],
  "store_start" : 4,
  "vendor_id" : 0,
  ...
  "content" : [ {
    ...
    "plans" : [ {
      "end_date" : 1,
      "initial_fee" : 4.272560517451799,
      "late_payment_fee" : 6.950034267368233,
      "billing_cycle_length" : 8,
      "reactivation_sku" : "aeiou",
      "currency_code" : "aeiou",
      "recurring_fee" : 1.506431433252533,
      "min_cycles" : 7,
      "recurring_sku" : "aeiou",
      "max_bill_attempts" : 2,
      "additional_properties" : {
      ...
      "name" : "aeiou",
      "billing_cycle_unit" : "millisecond",
      "reactivation_fee" : 0.46401076425893195,
      "max_cycles" : 1
    } ],
    "store_start" : 9,
    "vendor_id" : 1,
