...
open class StoreSubscriptionsAPI: APIBase {
  ...
  "plans" : [ {
    "end_date" : 6,
    "initial_fee" : 7.871093104403787,
    "late_payment_fee" : 1.1712170146392997,
    "billing_cycle_length" : 2,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 7.235050966022129,
    "min_cycles" : 0,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 4,
    ...
    "reactivation_fee" : 6.254235907401744,
    "max_cycles" : 1
  } ],
  "store_start" : 6,
  "vendor_id" : 5,
  ...
  "plans" : [ {
    "end_date" : 9,
    "initial_fee" : 7.653960823294431,
    "late_payment_fee" : 4.253650480153659,
    "billing_cycle_length" : 1,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 4.430447116760482,
    "min_cycles" : 7,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 5,
    "additional_properties" : {
    ...
    "name" : "aeiou",
    "billing_cycle_unit" : "millisecond",
    "reactivation_fee" : 6.510936680489548,
    "max_cycles" : 2
  } ],
  "store_start" : 5,
  "vendor_id" : 1,
  ...
  "content" : [ {
    ...
    "plans" : [ {
      "end_date" : 9,
      "initial_fee" : 3.0256842240068016,
      "late_payment_fee" : 2.3123155085100544,
      "billing_cycle_length" : 9,
      "reactivation_sku" : "aeiou",
      "currency_code" : "aeiou",
      "recurring_fee" : 4.036093215390921,
      "min_cycles" : 9,
      "recurring_sku" : "aeiou",
      "max_bill_attempts" : 6,
      "additional_properties" : {
      ...
      "name" : "aeiou",
      "billing_cycle_unit" : "millisecond",
      "reactivation_fee" : 4.601034649175057,
      "max_cycles" : 6
    } ],
    "store_start" : 4,
    "vendor_id" : 0,
