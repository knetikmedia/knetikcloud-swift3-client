...
open class StoreSubscriptionsAPI: APIBase {
  ...
  "plans" : [ {
    "end_date" : 6,
    "initial_fee" : 9.058629746969856,
    "late_payment_fee" : 1.9841585342964196,
    "billing_cycle_length" : 2,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 8.114925441882935,
    "min_cycles" : 8,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 4,
    ...
    "reactivation_fee" : 7.507308205512494,
    "max_cycles" : 0
  } ],
  "store_start" : 8,
  "vendor_id" : 6,
  ...
  "plans" : [ {
    "end_date" : 8,
    "initial_fee" : 3.240624142136036,
    "late_payment_fee" : 8.847866492973766,
    "billing_cycle_length" : 0,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 2.5329975479863465,
    "min_cycles" : 4,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 9,
    "additional_properties" : {
    ...
    "name" : "aeiou",
    "billing_cycle_unit" : "millisecond",
    "reactivation_fee" : 9.625085293467624,
    "max_cycles" : 6
  } ],
  "store_start" : 2,
  "vendor_id" : 8,
  ...
  "content" : [ {
    ...
    "plans" : [ {
      "end_date" : 5,
      "initial_fee" : 7.491579161934137,
      "late_payment_fee" : 9.509014315059554,
      "billing_cycle_length" : 4,
      "reactivation_sku" : "aeiou",
      "currency_code" : "aeiou",
      "recurring_fee" : 6.283634387570219,
      "min_cycles" : 6,
      "recurring_sku" : "aeiou",
      "max_bill_attempts" : 9,
      "additional_properties" : {
      ...
      "name" : "aeiou",
      "billing_cycle_unit" : "millisecond",
      "reactivation_fee" : 1.6190803138699528,
      "max_cycles" : 0
    } ],
    "store_start" : 5,
    "vendor_id" : 4,
