...
open class StoreSubscriptionsAPI: APIBase {
  ...
  "plans" : [ {
    "end_date" : 1,
    "initial_fee" : 0.9106679498663994,
    "late_payment_fee" : 1.9127933701208744,
    "billing_cycle_length" : 0,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 5.593316313284013,
    "min_cycles" : 5,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 6,
    ...
    "reactivation_fee" : 7.964329588554476,
    "max_cycles" : 5
  } ],
  "store_start" : 9,
  "vendor_id" : 7,
  ...
  "plans" : [ {
    "end_date" : 0,
    "initial_fee" : 1.3679913872503713,
    "late_payment_fee" : 8.61763500242169,
    "billing_cycle_length" : 8,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 1.7298701051323517,
    "min_cycles" : 3,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 0,
    "additional_properties" : {
    ...
    "name" : "aeiou",
    "billing_cycle_unit" : "millisecond",
    "reactivation_fee" : 2.0844370239118026,
    "max_cycles" : 2
  } ],
  "store_start" : 5,
  "vendor_id" : 1,
  ...
  "content" : [ {
    ...
    "plans" : [ {
      "end_date" : 0,
      "initial_fee" : 8.92798501359661,
      "late_payment_fee" : 4.7354908530594555,
      "billing_cycle_length" : 5,
      "reactivation_sku" : "aeiou",
      "currency_code" : "aeiou",
      "recurring_fee" : 9.953177857255179,
      "min_cycles" : 1,
      "recurring_sku" : "aeiou",
      "max_bill_attempts" : 8,
      "additional_properties" : {
      ...
      "name" : "aeiou",
      "billing_cycle_unit" : "millisecond",
      "reactivation_fee" : 7.787070501358031,
      "max_cycles" : 7
    } ],
    "store_start" : 7,
    "vendor_id" : 7,
