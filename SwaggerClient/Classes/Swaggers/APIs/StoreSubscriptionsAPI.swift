...
open class StoreSubscriptionsAPI: APIBase {
  ...
  "plans" : [ {
    "end_date" : 4,
    "initial_fee" : 1.6139141152359227,
    "late_payment_fee" : 4.8669206962625555,
    "billing_cycle_length" : 7,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 0.05063304748174735,
    "min_cycles" : 7,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 4,
    ...
    "reactivation_fee" : 1.3595468510783426,
    "max_cycles" : 3
  } ],
  "store_start" : 6,
  "vendor_id" : 0,
  ...
  "plans" : [ {
    "end_date" : 3,
    "initial_fee" : 5.54188536342634,
    "late_payment_fee" : 5.908213430441567,
    "billing_cycle_length" : 7,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 3.02340102019461,
    "min_cycles" : 8,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 6,
    "additional_properties" : {
    ...
    "name" : "aeiou",
    "billing_cycle_unit" : "millisecond",
    "reactivation_fee" : 3.5700586339077836,
    "max_cycles" : 1
  } ],
  "store_start" : 9,
  "vendor_id" : 7,
  ...
  "content" : [ {
    ...
    "plans" : [ {
      "end_date" : 5,
      "initial_fee" : 3.4788947476218537,
      "late_payment_fee" : 0.5981439275977918,
      "billing_cycle_length" : 5,
      "reactivation_sku" : "aeiou",
      "currency_code" : "aeiou",
      "recurring_fee" : 7.555861209421005,
      "min_cycles" : 1,
      "recurring_sku" : "aeiou",
      "max_bill_attempts" : 0,
      "additional_properties" : {
      ...
      "name" : "aeiou",
      "billing_cycle_unit" : "millisecond",
      "reactivation_fee" : 0.5530775192363224,
      "max_cycles" : 3
    } ],
    "store_start" : 0,
    "vendor_id" : 1,
