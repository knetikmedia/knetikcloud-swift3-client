...
open class StoreSubscriptionsAPI: APIBase {
  ...
  "plans" : [ {
    "end_date" : 0,
    "initial_fee" : 6.669544740952693,
    "late_payment_fee" : 3.017502477086633,
    "billing_cycle_length" : 4,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 1.082926796628677,
    "min_cycles" : 8,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 3,
    ...
    "reactivation_fee" : 8.296789271028933,
    "max_cycles" : 9
  } ],
  "store_start" : 4,
  "vendor_id" : 1,
  ...
  "plans" : [ {
    "end_date" : 2,
    "initial_fee" : 5.5180911978002145,
    "late_payment_fee" : 5.44681481270019,
    "billing_cycle_length" : 3,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 3.0686600477612744,
    "min_cycles" : 7,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 0,
    "additional_properties" : {
    ...
    "name" : "aeiou",
    "billing_cycle_unit" : "millisecond",
    "reactivation_fee" : 2.0815545777616453,
    "max_cycles" : 8
  } ],
  "store_start" : 4,
  "vendor_id" : 7,
  ...
  "content" : [ {
    ...
    "plans" : [ {
      "end_date" : 3,
      "initial_fee" : 5.3882138099240695,
      "late_payment_fee" : 1.4291994818812026,
      "billing_cycle_length" : 9,
      "reactivation_sku" : "aeiou",
      "currency_code" : "aeiou",
      "recurring_fee" : 0.4393070466563942,
      "min_cycles" : 7,
      "recurring_sku" : "aeiou",
      "max_bill_attempts" : 9,
      "additional_properties" : {
      ...
      "name" : "aeiou",
      "billing_cycle_unit" : "millisecond",
      "reactivation_fee" : 5.285373163254146,
      "max_cycles" : 6
    } ],
    "store_start" : 1,
    "vendor_id" : 1,
