...
open class StoreSubscriptionsAPI: APIBase {
  ...
  "plans" : [ {
    "end_date" : 5,
    "initial_fee" : 7.411155121208404,
    "late_payment_fee" : 5.8202109493678,
    "billing_cycle_length" : 4,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 0.5731746083546796,
    "min_cycles" : 6,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 9,
    ...
    "reactivation_fee" : 6.290971415104139,
    "max_cycles" : 2
  } ],
  "store_start" : 4,
  "vendor_id" : 8,
  ...
  "plans" : [ {
    "end_date" : 4,
    "initial_fee" : 3.544683033426944,
    "late_payment_fee" : 5.98483628078942,
    "billing_cycle_length" : 5,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 1.3240710446013548,
    "min_cycles" : 4,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 5,
    "additional_properties" : {
    ...
    "name" : "aeiou",
    "billing_cycle_unit" : "millisecond",
    "reactivation_fee" : 8.148567394473448,
    "max_cycles" : 7
  } ],
  "store_start" : 8,
  "vendor_id" : 2,
  ...
  "content" : [ {
    ...
    "plans" : [ {
      "end_date" : 7,
      "initial_fee" : 6.158859613913252,
      "late_payment_fee" : 2.187643965711108,
      "billing_cycle_length" : 0,
      "reactivation_sku" : "aeiou",
      "currency_code" : "aeiou",
      "recurring_fee" : 3.2948774792852964,
      "min_cycles" : 6,
      "recurring_sku" : "aeiou",
      "max_bill_attempts" : 5,
      "additional_properties" : {
      ...
      "name" : "aeiou",
      "billing_cycle_unit" : "millisecond",
      "reactivation_fee" : 3.895494984495922,
      "max_cycles" : 7
    } ],
    "store_start" : 6,
    "vendor_id" : 3,
