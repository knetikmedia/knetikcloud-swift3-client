...
open class StoreSubscriptionsAPI: APIBase {
  ...
  "plans" : [ {
    "end_date" : 6,
    "initial_fee" : 5.086161334564641,
    "late_payment_fee" : 2.349599879163291,
    "billing_cycle_length" : 0,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 0.6914403884549569,
    "min_cycles" : 2,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 1,
    ...
    "reactivation_fee" : 5.835002600692718,
    "max_cycles" : 2
  } ],
  "store_start" : 7,
  "vendor_id" : 1,
  ...
  "plans" : [ {
    "end_date" : 5,
    "initial_fee" : 9.902840561967048,
    "late_payment_fee" : 8.773811097797928,
    "billing_cycle_length" : 7,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 4.308885315731356,
    "min_cycles" : 9,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 8,
    "additional_properties" : {
    ...
    "name" : "aeiou",
    "billing_cycle_unit" : "millisecond",
    "reactivation_fee" : 2.00974939375703,
    "max_cycles" : 5
  } ],
  "store_start" : 3,
  "vendor_id" : 3,
  ...
  "content" : [ {
    ...
    "plans" : [ {
      "end_date" : 9,
      "initial_fee" : 7.759726966044749,
      "late_payment_fee" : 5.371428732930569,
      "billing_cycle_length" : 0,
      "reactivation_sku" : "aeiou",
      "currency_code" : "aeiou",
      "recurring_fee" : 8.669974418055881,
      "min_cycles" : 6,
      "recurring_sku" : "aeiou",
      "max_bill_attempts" : 3,
      "additional_properties" : {
      ...
      "name" : "aeiou",
      "billing_cycle_unit" : "millisecond",
      "reactivation_fee" : 2.461855628079348,
      "max_cycles" : 8
    } ],
    "store_start" : 6,
    "vendor_id" : 3,
