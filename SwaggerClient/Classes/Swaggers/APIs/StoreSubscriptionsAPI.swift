...
open class StoreSubscriptionsAPI: APIBase {
  ...
  "plans" : [ {
    "end_date" : 5,
    "initial_fee" : 9.05821507201164,
    "late_payment_fee" : 7.314189853447459,
    "billing_cycle_length" : 6,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 0.8075426051963652,
    "min_cycles" : 4,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 3,
    ...
    "reactivation_fee" : 8.198916508170491,
    "max_cycles" : 8
  } ],
  "store_start" : 6,
  "vendor_id" : 5,
  ...
  "plans" : [ {
    "end_date" : 1,
    "initial_fee" : 6.019841559812336,
    "late_payment_fee" : 8.256116410001221,
    "billing_cycle_length" : 6,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 6.687695191012688,
    "min_cycles" : 1,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 7,
    "additional_properties" : {
    ...
    "name" : "aeiou",
    "billing_cycle_unit" : "millisecond",
    "reactivation_fee" : 4.605182520679406,
    "max_cycles" : 4
  } ],
  "store_start" : 1,
  "vendor_id" : 5,
  ...
  "content" : [ {
    ...
    "plans" : [ {
      "end_date" : 3,
      "initial_fee" : 1.4368425320294453,
      "late_payment_fee" : 1.1618355598171348,
      "billing_cycle_length" : 5,
      "reactivation_sku" : "aeiou",
      "currency_code" : "aeiou",
      "recurring_fee" : 0.9066766634038625,
      "min_cycles" : 8,
      "recurring_sku" : "aeiou",
      "max_bill_attempts" : 1,
      "additional_properties" : {
      ...
      "name" : "aeiou",
      "billing_cycle_unit" : "millisecond",
      "reactivation_fee" : 0.009896488235067169,
      "max_cycles" : 7
    } ],
    "store_start" : 3,
    "vendor_id" : 5,
