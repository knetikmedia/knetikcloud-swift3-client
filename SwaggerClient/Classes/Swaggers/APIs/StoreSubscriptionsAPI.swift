...
open class StoreSubscriptionsAPI: APIBase {
  ...
  "plans" : [ {
    "end_date" : 5,
    "initial_fee" : 0.07698991850151993,
    "late_payment_fee" : 7.4650419660210225,
    "billing_cycle_length" : 0,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 5.362491749778857,
    "min_cycles" : 2,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 3,
    ...
    "reactivation_fee" : 6.3190539792289835,
    "max_cycles" : 0
  } ],
  "store_start" : 9,
  "vendor_id" : 3,
  ...
  "plans" : [ {
    "end_date" : 1,
    "initial_fee" : 7.892078389567803,
    "late_payment_fee" : 9.043899333507097,
    "billing_cycle_length" : 6,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 4.93181181262779,
    "min_cycles" : 9,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 3,
    "additional_properties" : {
    ...
    "name" : "aeiou",
    "billing_cycle_unit" : "millisecond",
    "reactivation_fee" : 0.5143292284226519,
    "max_cycles" : 3
  } ],
  "store_start" : 3,
  "vendor_id" : 5,
  ...
  "content" : [ {
    ...
    "plans" : [ {
      "end_date" : 6,
      "initial_fee" : 6.017940284640963,
      "late_payment_fee" : 0.6197884367677209,
      "billing_cycle_length" : 5,
      "reactivation_sku" : "aeiou",
      "currency_code" : "aeiou",
      "recurring_fee" : 4.055541497416946,
      "min_cycles" : 3,
      "recurring_sku" : "aeiou",
      "max_bill_attempts" : 7,
      "additional_properties" : {
      ...
      "name" : "aeiou",
      "billing_cycle_unit" : "millisecond",
      "reactivation_fee" : 5.70100399163986,
      "max_cycles" : 3
    } ],
    "store_start" : 5,
    "vendor_id" : 0,
