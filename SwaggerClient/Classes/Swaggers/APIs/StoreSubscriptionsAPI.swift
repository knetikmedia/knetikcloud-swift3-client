...
open class StoreSubscriptionsAPI: APIBase {
  ...
  "plans" : [ {
    "end_date" : 2,
    "initial_fee" : 4.220041617440376,
    "late_payment_fee" : 9.70372510008803,
    "billing_cycle_length" : 4,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 6.217499875917635,
    "min_cycles" : 9,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 5,
    ...
    "reactivation_fee" : 1.6857977860345053,
    "max_cycles" : 2
  } ],
  "store_start" : 1,
  "vendor_id" : 0,
  ...
  "plans" : [ {
    "end_date" : 6,
    "initial_fee" : 6.776394259199506,
    "late_payment_fee" : 2.2771768630268205,
    "billing_cycle_length" : 6,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 0.7989896957498244,
    "min_cycles" : 2,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 7,
    "additional_properties" : {
    ...
    "name" : "aeiou",
    "billing_cycle_unit" : "millisecond",
    "reactivation_fee" : 8.635296726606175,
    "max_cycles" : 5
  } ],
  "store_start" : 5,
  "vendor_id" : 4,
  ...
  "content" : [ {
    ...
    "plans" : [ {
      "end_date" : 0,
      "initial_fee" : 1.0375022442418602,
      "late_payment_fee" : 6.907197561231367,
      "billing_cycle_length" : 5,
      "reactivation_sku" : "aeiou",
      "currency_code" : "aeiou",
      "recurring_fee" : 3.6918690941749963,
      "min_cycles" : 9,
      "recurring_sku" : "aeiou",
      "max_bill_attempts" : 0,
      "additional_properties" : {
      ...
      "name" : "aeiou",
      "billing_cycle_unit" : "millisecond",
      "reactivation_fee" : 3.299105370308685,
      "max_cycles" : 6
    } ],
    "store_start" : 3,
    "vendor_id" : 0,
