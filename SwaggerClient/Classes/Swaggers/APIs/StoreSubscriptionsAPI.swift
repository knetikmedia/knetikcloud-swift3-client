...
open class StoreSubscriptionsAPI: APIBase {
  ...
  "plans" : [ {
    "end_date" : 4,
    "initial_fee" : 5.484950775942716,
    "late_payment_fee" : 5.211238238564885,
    "billing_cycle_length" : 4,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 7.50208749910982,
    "min_cycles" : 4,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 5,
    ...
    "reactivation_fee" : 4.740965330943876,
    "max_cycles" : 3
  } ],
  "store_start" : 6,
  "vendor_id" : 2,
  ...
  "plans" : [ {
    "end_date" : 8,
    "initial_fee" : 5.68228848407591,
    "late_payment_fee" : 7.04117026705328,
    "billing_cycle_length" : 5,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 3.6844993523715086,
    "min_cycles" : 7,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 6,
    "additional_properties" : {
    ...
    "name" : "aeiou",
    "billing_cycle_unit" : "millisecond",
    "reactivation_fee" : 6.307288905161334,
    "max_cycles" : 3
  } ],
  "store_start" : 0,
  "vendor_id" : 8,
  ...
  "content" : [ {
    ...
    "plans" : [ {
      "end_date" : 8,
      "initial_fee" : 1.0600366651407211,
      "late_payment_fee" : 4.495383479361933,
      "billing_cycle_length" : 2,
      "reactivation_sku" : "aeiou",
      "currency_code" : "aeiou",
      "recurring_fee" : 8.24100374893787,
      "min_cycles" : 8,
      "recurring_sku" : "aeiou",
      "max_bill_attempts" : 9,
      "additional_properties" : {
      ...
      "name" : "aeiou",
      "billing_cycle_unit" : "millisecond",
      "reactivation_fee" : 6.968208125156348,
      "max_cycles" : 5
    } ],
    "store_start" : 1,
    "vendor_id" : 0,
