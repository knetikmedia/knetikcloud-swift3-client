...
open class StoreSubscriptionsAPI: APIBase {
  ...
  "plans" : [ {
    "end_date" : 0,
    "initial_fee" : 1.5626110244832003,
    "late_payment_fee" : 5.812069807016975,
    "billing_cycle_length" : 2,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 8.44984177207583,
    "min_cycles" : 7,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 5,
    ...
    "reactivation_fee" : 0.011586892729064102,
    "max_cycles" : 8
  } ],
  "store_start" : 0,
  "vendor_id" : 2,
  ...
  "plans" : [ {
    "end_date" : 0,
    "initial_fee" : 4.709451670580974,
    "late_payment_fee" : 4.948687424323909,
    "billing_cycle_length" : 2,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 6.112180065934485,
    "min_cycles" : 5,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 8,
    "additional_properties" : {
    ...
    "name" : "aeiou",
    "billing_cycle_unit" : "millisecond",
    "reactivation_fee" : 8.836502592312039,
    "max_cycles" : 6
  } ],
  "store_start" : 4,
  "vendor_id" : 1,
  ...
  "content" : [ {
    ...
    "plans" : [ {
      "end_date" : 3,
      "initial_fee" : 7.275052716981642,
      "late_payment_fee" : 3.4467312510484973,
      "billing_cycle_length" : 0,
      "reactivation_sku" : "aeiou",
      "currency_code" : "aeiou",
      "recurring_fee" : 7.267931362024185,
      "min_cycles" : 2,
      "recurring_sku" : "aeiou",
      "max_bill_attempts" : 4,
      "additional_properties" : {
      ...
      "name" : "aeiou",
      "billing_cycle_unit" : "millisecond",
      "reactivation_fee" : 5.531007540148374,
      "max_cycles" : 5
    } ],
    "store_start" : 8,
    "vendor_id" : 9,
