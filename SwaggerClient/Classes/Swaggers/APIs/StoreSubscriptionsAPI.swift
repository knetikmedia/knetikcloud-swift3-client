...
open class StoreSubscriptionsAPI: APIBase {
  ...
  "plans" : [ {
    "end_date" : 9,
    "initial_fee" : 9.578258664672564,
    "late_payment_fee" : 3.688389908250189,
    "billing_cycle_length" : 3,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 5.994459778631614,
    "min_cycles" : 8,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 4,
    ...
    "reactivation_fee" : 7.629906384874879,
    "max_cycles" : 2
  } ],
  "store_start" : 7,
  "vendor_id" : 4,
  ...
  "plans" : [ {
    "end_date" : 7,
    "initial_fee" : 2.3863216409201202,
    "late_payment_fee" : 1.7409555135255106,
    "billing_cycle_length" : 7,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 6.433007409174452,
    "min_cycles" : 3,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 6,
    "additional_properties" : {
    ...
    "name" : "aeiou",
    "billing_cycle_unit" : "millisecond",
    "reactivation_fee" : 4.1118972789665476,
    "max_cycles" : 4
  } ],
  "store_start" : 9,
  "vendor_id" : 0,
  ...
  "content" : [ {
    ...
    "sort" : 9,
    "tags" : [ "aeiou" ],
    "consolidation_day_of_month" : 1,
    "plans" : [ {
      "end_date" : 4,
      "initial_fee" : 0.46836514188446254,
      "late_payment_fee" : 1.6762120586732032,
      "billing_cycle_length" : 9,
      "reactivation_sku" : "aeiou",
      "currency_code" : "aeiou",
      "recurring_fee" : 1.1079852377475818,
      "min_cycles" : 6,
      "recurring_sku" : "aeiou",
      "max_bill_attempts" : 2,
      "additional_properties" : {
      ...
      "name" : "aeiou",
      "billing_cycle_unit" : "millisecond",
      "reactivation_fee" : 2.4591026072095854,
      "max_cycles" : 0
    } ],
    "store_start" : 2,
    "vendor_id" : 9,
