...
open class ActivitiesAPI: APIBase {
  ...
  "status" : "aeiou"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getActivities(filterTemplate: Bool? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: @escaping ((_ data: PageResourceBareActivityResource?,_ error: Error?) -> Void)) {
  ...
  "first" : true
     ...
     */
    open class func getActivitiesWithRequestBuilder(filterTemplate: Bool? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageResourceBareActivityResource> {
        let path = "/activities"
        let URLString = SwaggerClientAPI.basePath + path
        let parameters: [String:Any]? = nil
  ...
  "users" : [ {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func updateActivity(id: Int64, activityResource: ActivityResource? = nil, completion: @escaping ((_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func updateActivityWithRequestBuilder(id: Int64, activityResource: ActivityResource? = nil) -> RequestBuilder<Void> {
        var path = "/activities/{id}"
        path = path.replacingOccurrences(of: "{id}", with: "\(id)", options: .literal, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
        let parameters = activityResource?.encodeToJSON() as? [String:AnyObject]
