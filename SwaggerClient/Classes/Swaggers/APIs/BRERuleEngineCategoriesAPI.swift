...
open class BRERuleEngineCategoriesAPI: APIBase {
  ...
  "properties" : [ {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getCategoriesUsingGET(size: Int32? = nil, page: Int32? = nil, completion: @escaping ((_ data: PageResourceBreCategoryResource?,_ error: Error?) -> Void)) {
  ...
  "first" : true
     ...
     */
    open class func getCategoriesUsingGETWithRequestBuilder(size: Int32? = nil, page: Int32? = nil) -> RequestBuilder<PageResourceBreCategoryResource> {
  ...
  "properties" : [ {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getTemplatesUsingGET(size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: @escaping ((_ data: PageResourceTemplateResource?,_ error: Error?) -> Void)) {
  ...
  "first" : true
     ...
     */
    open class func getTemplatesUsingGETWithRequestBuilder(size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageResourceTemplateResource> {
        let path = "/bre/categories/templates"
        let URLString = SwaggerClientAPI.basePath + path
