...
open class ContentPollsAPI: APIBase {
  ...
  "properties" : [ {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getPollTemplatesUsingGET(size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: @escaping ((_ data: PageResourceTemplateResource?,_ error: Error?) -> Void)) {
  ...
  "first" : true
     ...
     */
    open class func getPollTemplatesUsingGETWithRequestBuilder(size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageResourceTemplateResource> {
        let path = "/media/polls/templates"
        let URLString = SwaggerClientAPI.basePath + path
  ...
  "tags" : [ "aeiou" ]
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getPollsUsingGET(filterCategory: String? = nil, filterTagset: String? = nil, filterText: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: @escaping ((_ data: PageResourcePollResource?,_ error: Error?) -> Void)) {
  ...
  "first" : true
     ...
     */
    open class func getPollsUsingGETWithRequestBuilder(filterCategory: String? = nil, filterTagset: String? = nil, filterText: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageResourcePollResource> {
        let path = "/media/polls"
        let URLString = SwaggerClientAPI.basePath + path
