...
open class CampaignsRewardsAPI: APIBase {
  ...
  "item_rewards" : [ {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getRewardSetsUsingGET(size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: @escaping ((_ data: PageResourceRewardSetResource?,_ error: Error?) -> Void)) {
  ...
  "first" : true
     ...
     */
    open class func getRewardSetsUsingGETWithRequestBuilder(size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageResourceRewardSetResource> {
        let path = "/rewards"
        let URLString = SwaggerClientAPI.basePath + path
