...
open class GamificationTriviaAPI: APIBase {
  ...
  "id" : "aeiou"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getListUsingGET1(filterVendor: String? = nil, filterCategory: String? = nil, filterName: String? = nil, filterStatus: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: @escaping ((_ data: PageResourceImportJobResource?,_ error: Error?) -> Void)) {
  ...
  "first" : true
     ...
     */
    open class func getListUsingGET1WithRequestBuilder(filterVendor: String? = nil, filterCategory: String? = nil, filterName: String? = nil, filterStatus: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageResourceImportJobResource> {
        let path = "/trivia/import"
        let URLString = SwaggerClientAPI.basePath + path
  ...
  "properties" : [ "" ]
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getQuestionTemplatesUsingGET(size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: @escaping ((_ data: PageResourceQuestionTemplateResource?,_ error: Error?) -> Void)) {
  ...
  "first" : true
     ...
     */
    open class func getQuestionTemplatesUsingGETWithRequestBuilder(size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageResourceQuestionTemplateResource> {
        let path = "/trivia/questions/templates"
        let URLString = SwaggerClientAPI.basePath + path
