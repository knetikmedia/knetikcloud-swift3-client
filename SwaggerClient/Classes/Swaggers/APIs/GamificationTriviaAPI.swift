...
open class GamificationTriviaAPI: APIBase {
  ...
  "tags" : [ "aeiou" ]
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getQuestionTags1(filterSearch: String? = nil, filterCategory: String? = nil, filterImportId: Int64? = nil, completion: @escaping ((_ data: Collectionstring?,_ error: Error?) -> Void)) {
        getQuestionTags1WithRequestBuilder(filterSearch: filterSearch, filterCategory: filterCategory, filterImportId: filterImportId).execute { (response, error) -> Void in
            completion(response?.body, error);
        }
    }
     ...
     */
    open class func getQuestionTags1WithRequestBuilder(filterSearch: String? = nil, filterCategory: String? = nil, filterImportId: Int64? = nil) -> RequestBuilder<Collectionstring> {
  ...
  "first" : true
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getQuestions(size: Int32? = nil, page: Int32? = nil, order: String? = nil, filterSearch: String? = nil, filterIdset: String? = nil, filterCategory: String? = nil, filterTagset: String? = nil, filterType: String? = nil, filterPublished: Bool? = nil, filterImportId: Int64? = nil, completion: @escaping ((_ data: PageResourceQuestionResource?,_ error: Error?) -> Void)) {
        getQuestionsWithRequestBuilder(size: size, page: page, order: order, filterSearch: filterSearch, filterIdset: filterIdset, filterCategory: filterCategory, filterTagset: filterTagset, filterType: filterType, filterPublished: filterPublished, filterImportId: filterImportId).execute { (response, error) -> Void in
            completion(response?.body, error);
        }
    }
  ...
  "published_date" : 123456789
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func updateQuestionTemplate(id: String, questionTemplateResource: QuestionTemplateResource? = nil, completion: @escaping ((_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func updateQuestionTemplateWithRequestBuilder(id: String, questionTemplateResource: QuestionTemplateResource? = nil) -> RequestBuilder<Void> {
        var path = "/trivia/questions/templates/{id}"
        path = path.replacingOccurrences(of: "{id}", with: "\(id)", options: .literal, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
        let parameters = questionTemplateResource?.encodeToJSON() as? [String:AnyObject]
