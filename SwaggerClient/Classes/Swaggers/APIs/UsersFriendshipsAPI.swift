...
open class UsersFriendshipsAPI: APIBase {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getFriendsUsingGET(userId: String, size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: @escaping ((_ data: PageSimpleUserResource?,_ error: Error?) -> Void)) {
  ...
  "first" : true
     ...
     */
    open class func getFriendsUsingGETWithRequestBuilder(userId: String, size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageSimpleUserResource> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getInvitesUsingGET(userId: String, size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: @escaping ((_ data: PageSimpleUserResource?,_ error: Error?) -> Void)) {
  ...
  "first" : true
     ...
     - returns: RequestBuilder<PageSimpleUserResource> 
     */
    open class func getInvitesUsingGETWithRequestBuilder(userId: String, size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageSimpleUserResource> {
