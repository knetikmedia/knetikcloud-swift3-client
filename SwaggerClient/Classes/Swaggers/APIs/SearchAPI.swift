...
open class SearchAPI: APIBase {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func searchUsingPOST(type: String, query: Any? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: @escaping ((_ data: PageMapstringobject?,_ error: Error?) -> Void)) {
     ...
     */
    open class func searchUsingPOSTWithRequestBuilder(type: String, query: Any? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageMapstringobject> {
        var path = "/search/index/{type}"
        path = path.replacingOccurrences(of: "{type}", with: "\(type)", options: .literal, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
