...
open class PaymentsStripeAPI: APIBase {
     ...
     */
    open class func createCustomerUsingPOST(request: StripeCreatePaymentMethod? = nil, completion: @escaping ((_ data: PaymentMethodResource?,_ error: Error?) -> Void)) {
  ...
  "updated_date" : 123456789
     ...
     */
    open class func createCustomerUsingPOSTWithRequestBuilder(request: StripeCreatePaymentMethod? = nil) -> RequestBuilder<PaymentMethodResource> {
