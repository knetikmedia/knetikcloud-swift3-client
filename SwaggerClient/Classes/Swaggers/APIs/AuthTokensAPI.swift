...
open class AuthTokensAPI: APIBase {
  ...
  "username" : "aeiou"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getTokensUsingGET(filterClientId: String? = nil, filterUsername: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: @escaping ((_ data: PageResourceOauthAccessTokenResource?,_ error: Error?) -> Void)) {
  ...
  "first" : true
     ...
     */
    open class func getTokensUsingGETWithRequestBuilder(filterClientId: String? = nil, filterUsername: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageResourceOauthAccessTokenResource> {
