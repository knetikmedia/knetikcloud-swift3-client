...
open class BRERuleEngineRulesAPI: APIBase {
     ...
     */
    open class func convertExpressionToStringUsingPOST(expression: Expressionobject? = nil, completion: @escaping ((_ data: String?,_ error: Error?) -> Void)) {
        convertExpressionToStringUsingPOSTWithRequestBuilder(expression: expression).execute { (response, error) -> Void in
     ...
     */
    open class func convertExpressionToStringUsingPOSTWithRequestBuilder(expression: Expressionobject? = nil) -> RequestBuilder<String> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func createRuleUsingPOST(breRule: BreRule? = nil, completion: @escaping ((_ data: BreRule?,_ error: Error?) -> Void)) {
        createRuleUsingPOSTWithRequestBuilder(breRule: breRule).execute { (response, error) -> Void in
            completion(response?.body, error);
        }
    }
     ...
     */
    open class func createRuleUsingPOSTWithRequestBuilder(breRule: BreRule? = nil) -> RequestBuilder<BreRule> {
        let path = "/bre/rules"
        let URLString = SwaggerClientAPI.basePath + path
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func deleteRuleUsingDELETE(id: String, completion: @escaping ((_ error: Error?) -> Void)) {
        deleteRuleUsingDELETEWithRequestBuilder(id: id).execute { (response, error) -> Void in
            completion(error);
        }
    }
     ...
     */
    open class func deleteRuleUsingDELETEWithRequestBuilder(id: String) -> RequestBuilder<Void> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func enableRuleUsingPUT(id: String, enabled: BooleanResource? = nil, completion: @escaping ((_ error: Error?) -> Void)) {
        enableRuleUsingPUTWithRequestBuilder(id: id, enabled: enabled).execute { (response, error) -> Void in
            completion(error);
        }
    }
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func enableRuleUsingPUTWithRequestBuilder(id: String, enabled: BooleanResource? = nil) -> RequestBuilder<Void> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getRuleUsingGET(id: String, completion: @escaping ((_ data: BreRule?,_ error: Error?) -> Void)) {
        getRuleUsingGETWithRequestBuilder(id: id).execute { (response, error) -> Void in
            completion(response?.body, error);
        }
    }
    ...
    /**
     ...
     - returns: RequestBuilder<BreRule> 
     */
    open class func getRuleUsingGETWithRequestBuilder(id: String) -> RequestBuilder<BreRule> {
        var path = "/bre/rules/{id}"
        path = path.replacingOccurrences(of: "{id}", with: "\(id)", options: .literal, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getRulesUsingGET(filterName: String? = nil, filterEnabled: Bool? = nil, filterSystem: Bool? = nil, filterTrigger: String? = nil, filterAction: String? = nil, filterCondition: String? = nil, size: Int32? = nil, page: Int32? = nil, completion: @escaping ((_ data: PageBreRule?,_ error: Error?) -> Void)) {
        getRulesUsingGETWithRequestBuilder(filterName: filterName, filterEnabled: filterEnabled, filterSystem: filterSystem, filterTrigger: filterTrigger, filterAction: filterAction, filterCondition: filterCondition, size: size, page: page).execute { (response, error) -> Void in
            completion(response?.body, error);
        }
    }
    ...
    /**
     ...
     - returns: RequestBuilder<PageBreRule> 
     */
    open class func getRulesUsingGETWithRequestBuilder(filterName: String? = nil, filterEnabled: Bool? = nil, filterSystem: Bool? = nil, filterTrigger: String? = nil, filterAction: String? = nil, filterCondition: String? = nil, size: Int32? = nil, page: Int32? = nil) -> RequestBuilder<PageBreRule> {
        let path = "/bre/rules"
        let URLString = SwaggerClientAPI.basePath + path
        ...
        let requestBuilder: RequestBuilder<PageBreRule>.Type = SwaggerClientAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func updateRuleUsingPUT(id: String, breRule: BreRule? = nil, completion: @escaping ((_ error: Error?) -> Void)) {
        updateRuleUsingPUTWithRequestBuilder(id: id, breRule: breRule).execute { (response, error) -> Void in
            completion(error);
        }
    }
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func updateRuleUsingPUTWithRequestBuilder(id: String, breRule: BreRule? = nil) -> RequestBuilder<Void> {
        var path = "/bre/rules/{id}"
        path = path.replacingOccurrences(of: "{id}", with: "\(id)", options: .literal, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
        let parameters = breRule?.encodeToJSON() as? [String:AnyObject]
