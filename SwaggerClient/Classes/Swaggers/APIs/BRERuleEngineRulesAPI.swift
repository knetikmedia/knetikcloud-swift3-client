...
open class BRERuleEngineRulesAPI: APIBase {
  ...
  "start_date" : 123456789
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getRulesUsingGET(filterName: String? = nil, filterEnabled: Bool? = nil, filterSystem: Bool? = nil, filterTrigger: String? = nil, filterAction: String? = nil, filterCondition: String? = nil, size: Int32? = nil, page: Int32? = nil, completion: @escaping ((_ data: PageResourceBreRule?,_ error: Error?) -> Void)) {
  ...
  "first" : true
     ...
     */
    open class func getRulesUsingGETWithRequestBuilder(filterName: String? = nil, filterEnabled: Bool? = nil, filterSystem: Bool? = nil, filterTrigger: String? = nil, filterAction: String? = nil, filterCondition: String? = nil, size: Int32? = nil, page: Int32? = nil) -> RequestBuilder<PageResourceBreRule> {
        let path = "/bre/rules"
        let URLString = SwaggerClientAPI.basePath + path
        let parameters: [String:Any]? = nil
