...
open class PaymentsWalletsAPI: APIBase {
     ...
     */
    open class func getWalletTotalsUsingGET(completion: @escaping ((_ data: PageWalletTotalResponse?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<PageWalletTotalResponse> 
     */
    open class func getWalletTotalsUsingGETWithRequestBuilder() -> RequestBuilder<PageWalletTotalResponse> {
        ...
        let requestBuilder: RequestBuilder<PageWalletTotalResponse>.Type = SwaggerClientAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getWalletsUsingGET1(size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: @escaping ((_ data: PageSimpleWallet?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<PageSimpleWallet> 
     */
    open class func getWalletsUsingGET1WithRequestBuilder(size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageSimpleWallet> {
        let path = "/wallets"
        let URLString = SwaggerClientAPI.basePath + path
        ...
        let requestBuilder: RequestBuilder<PageSimpleWallet>.Type = SwaggerClientAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - returns: RequestBuilder<PageWalletTransactionResource> 
     */
    open class func transactionHistoryUsingGETWithRequestBuilder(filterInvoice: Int32? = nil, filterType: String? = nil, filterMaxDate: Int64? = nil, filterMinDate: Int64? = nil, filterSign: FilterSign_transactionHistoryUsingGET? = nil, filterUserId: Int32? = nil, filterUsername: String? = nil, filterDetails: String? = nil, filterCurrencyCode: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageWalletTransactionResource> {
        ...
        let requestBuilder: RequestBuilder<PageWalletTransactionResource>.Type = SwaggerClientAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func userTransactionHistoryUsingGET(userId: Int32, currencyCode: String, filterType: String? = nil, filterMaxDate: Int64? = nil, filterMinDate: Int64? = nil, filterSign: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: @escaping ((_ data: PageWalletTransactionResource?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<PageWalletTransactionResource> 
     */
    open class func userTransactionHistoryUsingGETWithRequestBuilder(userId: Int32, currencyCode: String, filterType: String? = nil, filterMaxDate: Int64? = nil, filterMinDate: Int64? = nil, filterSign: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageWalletTransactionResource> {
