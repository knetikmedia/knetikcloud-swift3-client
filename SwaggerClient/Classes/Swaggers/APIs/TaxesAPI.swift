...
open class TaxesAPI: APIBase {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getAllTaxesUsingGET(size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: @escaping ((_ data: PageStateTaxResource?,_ error: Error?) -> Void)) {
  ...
  "first" : true
     ...
     */
    open class func getAllTaxesUsingGETWithRequestBuilder(size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageStateTaxResource> {
        let path = "/tax/states"
        let URLString = SwaggerClientAPI.basePath + path
  ...
  "country_iso3" : "aeiou"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getTaxesUsingGET(size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: @escaping ((_ data: PageCountryTaxResource?,_ error: Error?) -> Void)) {
  ...
  "first" : true
     ...
     */
    open class func getTaxesUsingGETWithRequestBuilder(size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageCountryTaxResource> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getTaxesUsingGET1(countryCodeIso3: String, size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: @escaping ((_ data: PageStateTaxResource?,_ error: Error?) -> Void)) {
  ...
  "first" : true
     ...
     - returns: RequestBuilder<PageStateTaxResource> 
     */
    open class func getTaxesUsingGET1WithRequestBuilder(countryCodeIso3: String, size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageStateTaxResource> {
        var path = "/tax/countries/{country_code_iso3}/states"
        path = path.replacingOccurrences(of: "{countryCodeIso3}", with: "\(countryCodeIso3)", options: .literal, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
