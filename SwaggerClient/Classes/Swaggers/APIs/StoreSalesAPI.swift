...
open class StoreSalesAPI: APIBase {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getCatalogSalesUsingGET(size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: @escaping ((_ data: PageCatalogSale?,_ error: Error?) -> Void)) {
     ...
     */
    open class func getCatalogSalesUsingGETWithRequestBuilder(size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageCatalogSale> {
        let path = "/store/sales"
        let URLString = SwaggerClientAPI.basePath + path
