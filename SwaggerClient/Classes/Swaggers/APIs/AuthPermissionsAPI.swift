...
open class AuthPermissionsAPI: APIBase {
  ...
  "locked" : false
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getPermissionUsingGET1(size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: @escaping ((_ data: PageResourcePermissionResource?,_ error: Error?) -> Void)) {
  ...
  "first" : true
     ...
     */
    open class func getPermissionUsingGET1WithRequestBuilder(size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageResourcePermissionResource> {
        let path = "/auth/permissions"
        let URLString = SwaggerClientAPI.basePath + path
