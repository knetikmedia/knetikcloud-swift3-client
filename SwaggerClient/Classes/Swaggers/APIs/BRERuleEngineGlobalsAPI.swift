...
open class BRERuleEngineGlobalsAPI: APIBase {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getGlobalsUsingGET(filterSystem: Bool? = nil, size: Int32? = nil, page: Int32? = nil, completion: @escaping ((_ data: PageBreGlobalResource?,_ error: Error?) -> Void)) {
     ...
     */
    open class func getGlobalsUsingGETWithRequestBuilder(filterSystem: Bool? = nil, size: Int32? = nil, page: Int32? = nil) -> RequestBuilder<PageBreGlobalResource> {
        let path = "/bre/globals/definitions"
        let URLString = SwaggerClientAPI.basePath + path
