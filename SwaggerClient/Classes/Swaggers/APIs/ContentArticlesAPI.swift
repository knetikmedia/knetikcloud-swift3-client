...
open class ContentArticlesAPI: APIBase {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getArticleTemplatesUsingGET(size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: @escaping ((_ data: PageTemplateResource?,_ error: Error?) -> Void)) {
     ...
     */
    open class func getArticleTemplatesUsingGETWithRequestBuilder(size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageTemplateResource> {
        let path = "/content/articles/templates"
        let URLString = SwaggerClientAPI.basePath + path
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getArticlesUsingGET(filterCategory: String? = nil, filterTagset: String? = nil, filterTitle: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: @escaping ((_ data: PageArticleResource?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<PageArticleResource> 
     */
    open class func getArticlesUsingGETWithRequestBuilder(filterCategory: String? = nil, filterTagset: String? = nil, filterTitle: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageArticleResource> {
        let path = "/content/articles"
        let URLString = SwaggerClientAPI.basePath + path
        ...
        let requestBuilder: RequestBuilder<PageArticleResource>.Type = SwaggerClientAPI.requestBuilderFactory.getBuilder()
