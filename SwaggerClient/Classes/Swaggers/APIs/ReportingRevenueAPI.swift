...
open class ReportingRevenueAPI: APIBase {
  ...
  "sales_average" : 0.09357515348002998,
  "sale_count" : 9,
  "sales_total" : 2.496850046143908,
  "customer_count" : 9
}}]
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 6.468330305470415,
  "sale_count" : 2,
  "sales_total" : 7.626056457487592,
  "customer_count" : 3
}}]
  ...
  "first" : true
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 9.058822778674612,
  "sale_count" : 9,
  "sales_total" : 2.669841646933022,
  "customer_count" : 3
}}]
