...
open class ReportingRevenueAPI: APIBase {
  ...
  "sales_average" : 0.6480186103494423,
  "sale_count" : 5,
  "sales_total" : 2.230285161766475,
  "customer_count" : 4
}}]
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 7.747978435950959,
  "sale_count" : 0,
  "sales_total" : 2.0518196949061505,
  "customer_count" : 8
}}]
  ...
  "first" : true
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 4.838157684834047,
  "sale_count" : 8,
  "sales_total" : 7.89788861339976,
  "customer_count" : 0
}}]
