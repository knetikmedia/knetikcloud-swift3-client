...
open class ReportingRevenueAPI: APIBase {
  ...
  "sales_average" : 1.2094480395390372,
  "sale_count" : 9,
  "sales_total" : 2.07460144736602,
  "customer_count" : 3
}}]
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 5.29297779625463,
  "sale_count" : 8,
  "sales_total" : 0.35792223360630815,
  "customer_count" : 8
}}]
  ...
  "first" : true
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 8.833794778427682,
  "sale_count" : 1,
  "sales_total" : 7.899287750411467,
  "customer_count" : 2
}}]
