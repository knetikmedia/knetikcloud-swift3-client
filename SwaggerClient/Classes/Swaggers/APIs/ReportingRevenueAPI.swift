...
open class ReportingRevenueAPI: APIBase {
  ...
  "sales_average" : 7.471397790036438,
  "sale_count" : 0,
  "sales_total" : 5.505494758402065,
  "customer_count" : 3
}}]
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 9.052492753238212,
  "sale_count" : 9,
  "sales_total" : 4.534688100684898,
  "customer_count" : 5
}}]
  ...
  "first" : true
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 7.500301248266953,
  "sale_count" : 3,
  "sales_total" : 2.178244467352337,
  "customer_count" : 9
}}]
