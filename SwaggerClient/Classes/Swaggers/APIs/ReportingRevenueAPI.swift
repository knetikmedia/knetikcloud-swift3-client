...
open class ReportingRevenueAPI: APIBase {
  ...
  "sales_average" : 9.273394180916892,
  "sale_count" : 9,
  "sales_total" : 1.7798702739173677,
  "customer_count" : 1
}}]
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 4.6134735174330785,
  "sale_count" : 9,
  "sales_total" : 0.5838838670787583,
  "customer_count" : 1
}}]
  ...
  "first" : true
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 0.6038022492639095,
  "sale_count" : 1,
  "sales_total" : 0.6563457949623497,
  "customer_count" : 6
}}]
