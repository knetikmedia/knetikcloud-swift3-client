...
open class ReportingRevenueAPI: APIBase {
     ...
     */
    open class func executiveRevenueCountrySalesUsingGET(currencyCode: String, startDate: Int64? = nil, endDate: Int64? = nil, size: Int32? = nil, page: Int32? = nil, completion: @escaping ((_ data: PageResourceRevenueCountryReportResource?,_ error: Error?) -> Void)) {
  ...
  "first" : true
     ...
     */
    open class func executiveRevenueCountrySalesUsingGETWithRequestBuilder(currencyCode: String, startDate: Int64? = nil, endDate: Int64? = nil, size: Int32? = nil, page: Int32? = nil) -> RequestBuilder<PageResourceRevenueCountryReportResource> {
  ...
  "customer_count" : 123456789
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func executiveRevenueProductSalesUsingGET(currencyCode: String, startDate: Int64? = nil, endDate: Int64? = nil, size: Int32? = nil, page: Int32? = nil, completion: @escaping ((_ data: PageResourceRevenueProductReportResource?,_ error: Error?) -> Void)) {
  ...
  "first" : true
     ...
     */
    open class func executiveRevenueProductSalesUsingGETWithRequestBuilder(currencyCode: String, startDate: Int64? = nil, endDate: Int64? = nil, size: Int32? = nil, page: Int32? = nil) -> RequestBuilder<PageResourceRevenueProductReportResource> {
