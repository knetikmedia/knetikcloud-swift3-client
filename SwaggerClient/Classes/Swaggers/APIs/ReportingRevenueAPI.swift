...
open class ReportingRevenueAPI: APIBase {
  ...
  "sales_average" : 7.428004791902777,
  "sale_count" : 6,
  "sales_total" : 3.8291178236497423,
  "customer_count" : 6
}}]
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 7.000528898130453,
  "sale_count" : 0,
  "sales_total" : 4.446730047715342,
  "customer_count" : 7
}}]
  ...
  "first" : true
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 7.457533134615115,
  "sale_count" : 0,
  "sales_total" : 3.667097010687035,
  "customer_count" : 5
}}]
