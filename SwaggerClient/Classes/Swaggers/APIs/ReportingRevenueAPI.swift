...
open class ReportingRevenueAPI: APIBase {
  ...
  "sales_average" : 5.472864162279441,
  "sale_count" : 0,
  "sales_total" : 2.581770992980613,
  "customer_count" : 4
}}]
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 7.506072896582241,
  "sale_count" : 5,
  "sales_total" : 0.1412259476861788,
  "customer_count" : 6
}}]
  ...
  "first" : true
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 5.096574785917557,
  "sale_count" : 4,
  "sales_total" : 3.544330159118061,
  "customer_count" : 5
}}]
