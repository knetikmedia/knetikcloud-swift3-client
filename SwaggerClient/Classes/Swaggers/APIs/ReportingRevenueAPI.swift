...
open class ReportingRevenueAPI: APIBase {
  ...
  "sales_average" : 3.6289275372206764,
  "sale_count" : 4,
  "sales_total" : 7.050816592309477,
  "customer_count" : 6
}}]
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 0.7082403686092009,
  "sale_count" : 8,
  "sales_total" : 6.606410428924525,
  "customer_count" : 8
}}]
  ...
  "first" : true
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 2.682605289488432,
  "sale_count" : 5,
  "sales_total" : 0.5465882088445895,
  "customer_count" : 2
}}]
