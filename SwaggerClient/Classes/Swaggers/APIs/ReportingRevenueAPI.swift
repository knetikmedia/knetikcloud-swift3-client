...
open class ReportingRevenueAPI: APIBase {
  ...
  "sales_average" : 2.9677625518726636,
  "sale_count" : 5,
  "sales_total" : 2.517656544694975,
  "customer_count" : 9
}}]
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 8.440945613888008,
  "sale_count" : 5,
  "sales_total" : 6.752544046727071,
  "customer_count" : 0
}}]
  ...
  "first" : true
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 6.177510340419143,
  "sale_count" : 1,
  "sales_total" : 9.336152512358012,
  "customer_count" : 6
}}]
