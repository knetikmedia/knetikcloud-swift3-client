...
open class ReportingRevenueAPI: APIBase {
  ...
  "sales_average" : 3.76805264547039,
  "sale_count" : 8,
  "sales_total" : 0.8184018952066774,
  "customer_count" : 4
}}]
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 7.058020121594122,
  "sale_count" : 4,
  "sales_total" : 1.301978354086769,
  "customer_count" : 5
}}]
  ...
  "first" : true
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 1.6195447601754598,
  "sale_count" : 8,
  "sales_total" : 3.9398629224122184,
  "customer_count" : 5
}}]
