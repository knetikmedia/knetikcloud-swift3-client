...
open class ReportingRevenueAPI: APIBase {
  ...
  "sales_average" : 9.021067264372387,
  "sale_count" : 6,
  "sales_total" : 8.561341422109875,
  "customer_count" : 3
}}]
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 4.817370274813573,
  "sale_count" : 4,
  "sales_total" : 6.64167352232753,
  "customer_count" : 0
}}]
  ...
  "first" : true
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 4.310395378420227,
  "sale_count" : 5,
  "sales_total" : 0.9278237459136451,
  "customer_count" : 4
}}]
