...
open class ReportingRevenueAPI: APIBase {
  ...
  "sales_average" : 7.189976916622446,
  "sale_count" : 4,
  "sales_total" : 9.493517924144728,
  "customer_count" : 4
}}]
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 9.298750979347556,
  "sale_count" : 6,
  "sales_total" : 2.987379122445084,
  "customer_count" : 0
}}]
  ...
  "first" : true
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 9.266277634167906,
  "sale_count" : 2,
  "sales_total" : 9.216541393709727,
  "customer_count" : 6
}}]
