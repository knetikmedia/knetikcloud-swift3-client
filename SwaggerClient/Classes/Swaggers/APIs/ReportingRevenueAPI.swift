...
open class ReportingRevenueAPI: APIBase {
  ...
  "sales_average" : 5.418052926876946,
  "sale_count" : 9,
  "sales_total" : 0.7292664124516512,
  "customer_count" : 3
}}]
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 9.600319805251756,
  "sale_count" : 7,
  "sales_total" : 5.566227895518313,
  "customer_count" : 2
}}]
  ...
  "first" : true
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 4.493369895873506,
  "sale_count" : 7,
  "sales_total" : 3.6071073637743076,
  "customer_count" : 2
}}]
