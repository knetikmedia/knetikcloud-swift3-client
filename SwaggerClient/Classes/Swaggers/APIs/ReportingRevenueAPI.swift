...
open class ReportingRevenueAPI: APIBase {
  ...
  "sales_average" : 0.9127429969152556,
  "sale_count" : 6,
  "sales_total" : 9.22637759956046,
  "customer_count" : 6
}}]
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 8.569902818934347,
  "sale_count" : 0,
  "sales_total" : 5.833499432857028,
  "customer_count" : 1
}}]
  ...
  "first" : true
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 8.616718894910356,
  "sale_count" : 8,
  "sales_total" : 9.92241714127036,
  "customer_count" : 2
}}]
