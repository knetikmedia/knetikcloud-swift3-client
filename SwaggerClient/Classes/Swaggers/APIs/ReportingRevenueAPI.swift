...
open class ReportingRevenueAPI: APIBase {
  ...
  "sales_average" : 8.417174153950427,
  "sale_count" : 3,
  "sales_total" : 2.3621581957212925,
  "customer_count" : 5
}}]
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 9.387260540623224,
  "sale_count" : 2,
  "sales_total" : 0.9340380079189514,
  "customer_count" : 9
}}]
  ...
  "first" : true
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 1.7070503433186268,
  "sale_count" : 8,
  "sales_total" : 5.000931836139452,
  "customer_count" : 3
}}]
