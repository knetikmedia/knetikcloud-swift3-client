...
open class ReportingRevenueAPI: APIBase {
  ...
  "sales_average" : 9.673580041692132,
  "sale_count" : 7,
  "sales_total" : 1.1603724461576215,
  "customer_count" : 8
}}]
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 4.556027486667629,
  "sale_count" : 2,
  "sales_total" : 7.717544305989227,
  "customer_count" : 4
}}]
  ...
  "first" : true
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 2.4414421809961517,
  "sale_count" : 0,
  "sales_total" : 6.109069002361906,
  "customer_count" : 9
}}]
