...
open class ReportingRevenueAPI: APIBase {
  ...
  "sales_average" : 4.298266265374199,
  "sale_count" : 2,
  "sales_total" : 9.451201971395779,
  "customer_count" : 4
}}]
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 5.3576412339957455,
  "sale_count" : 6,
  "sales_total" : 0.6249704280485702,
  "customer_count" : 7
}}]
  ...
  "first" : true
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 9.453281753312549,
  "sale_count" : 9,
  "sales_total" : 2.6690019338993975,
  "customer_count" : 5
}}]
