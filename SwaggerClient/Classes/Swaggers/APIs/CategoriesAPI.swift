...
open class CategoriesAPI: APIBase {
  ...
  "properties" : [ {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getArticleTemplatesUsingGET1(size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: @escaping ((_ data: PageResourceTemplateResource?,_ error: Error?) -> Void)) {
  ...
  "first" : true
     ...
     */
    open class func getArticleTemplatesUsingGET1WithRequestBuilder(size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageResourceTemplateResource> {
        let path = "/categories/templates"
        let URLString = SwaggerClientAPI.basePath + path
        let parameters: [String:Any]? = nil
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getCategoriesUsingGET1(filterSearch: String? = nil, filterActive: Bool? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: @escaping ((_ data: PageResourceCategoryResource?,_ error: Error?) -> Void)) {
  ...
  "first" : true
     ...
     */
    open class func getCategoriesUsingGET1WithRequestBuilder(filterSearch: String? = nil, filterActive: Bool? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageResourceCategoryResource> {
        let path = "/categories"
        let URLString = SwaggerClientAPI.basePath + path
        let parameters: [String:Any]? = nil
  ...
  "id" : "aeiou"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getTagsUsingGET(size: Int32? = nil, page: Int32? = nil, completion: @escaping ((_ data: PageResourcestring?,_ error: Error?) -> Void)) {
  ...
  "first" : true
     ...
     */
    open class func getTagsUsingGETWithRequestBuilder(size: Int32? = nil, page: Int32? = nil) -> RequestBuilder<PageResourcestring> {
        let path = "/tags"
        let URLString = SwaggerClientAPI.basePath + path
        let parameters: [String:Any]? = nil
