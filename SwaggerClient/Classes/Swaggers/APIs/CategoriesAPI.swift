...
open class CategoriesAPI: APIBase {
  ...
  "id" : "aeiou"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getTagsUsingGET(size: Int32? = nil, page: Int32? = nil, completion: @escaping ((_ data: Pagestring?,_ error: Error?) -> Void)) {
  ...
  "first" : true
     ...
     */
    open class func getTagsUsingGETWithRequestBuilder(size: Int32? = nil, page: Int32? = nil) -> RequestBuilder<Pagestring> {
        let path = "/tags"
        let URLString = SwaggerClientAPI.basePath + path
