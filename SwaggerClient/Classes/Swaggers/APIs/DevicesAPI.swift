...
open class DevicesAPI: APIBase {
  ...
  "status" : "aeiou"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getDevicesUsingGET(filterMake: String? = nil, filterModel: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: @escaping ((_ data: PageResourceDeviceResource?,_ error: Error?) -> Void)) {
  ...
  "first" : true
     ...
     */
    open class func getDevicesUsingGETWithRequestBuilder(filterMake: String? = nil, filterModel: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageResourceDeviceResource> {
        let path = "/devices"
        let URLString = SwaggerClientAPI.basePath + path
