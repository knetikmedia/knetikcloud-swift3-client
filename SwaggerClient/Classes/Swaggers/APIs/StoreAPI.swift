...
open class StoreAPI: APIBase {
  ...
  "first" : true
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getUsingGET2(limit: Int32? = nil, page: Int32? = nil, useCatalog: Bool? = nil, ignoreLocation: Bool? = nil, inStockOnly: Bool? = nil, completion: @escaping ((_ data: PageResourceStoreItem?,_ error: Error?) -> Void)) {
        getUsingGET2WithRequestBuilder(limit: limit, page: page, useCatalog: useCatalog, ignoreLocation: ignoreLocation, inStockOnly: inStockOnly).execute { (response, error) -> Void in
            completion(response?.body, error);
        }
    }
  ...
  "first" : true
     ...
     - returns: RequestBuilder<PageResourceStoreItem> 
     */
    open class func getUsingGET2WithRequestBuilder(limit: Int32? = nil, page: Int32? = nil, useCatalog: Bool? = nil, ignoreLocation: Bool? = nil, inStockOnly: Bool? = nil) -> RequestBuilder<PageResourceStoreItem> {
        let path = "/store"
        let URLString = SwaggerClientAPI.basePath + path
        let parameters: [String:Any]? = nil
