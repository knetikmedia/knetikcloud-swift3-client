...
open class StoreAPI: APIBase {
  ...
  "skus" : [ {
    "sale_id" : 2,
    "original_price" : 4.654981124470629,
    "description" : "aeiou",
    "stop_date" : 8,
    "published" : false,
    "inventory" : 5,
  ...
  "content" : [ {
    ...
    "skus" : [ {
      "sale_id" : 7,
      "original_price" : 5.868525893392692,
      "description" : "aeiou",
      "stop_date" : 4,
      "published" : false,
      "inventory" : 8,
  ...
  "skus" : [ {
    "sale_id" : 7,
    "original_price" : 9.014253052430007,
    "description" : "aeiou",
    "stop_date" : 1,
    "published" : false,
    "inventory" : 6,
  ...
  "content" : [ {
    ...
    "skus" : [ {
      "sale_id" : 8,
      "original_price" : 3.1317020068665355,
      "description" : "aeiou",
      "stop_date" : 9,
      "published" : false,
      "inventory" : 2,
  ...
  "skus" : [ {
    "sale_id" : 9,
    "original_price" : 6.222199134078577,
    "description" : "aeiou",
    "stop_date" : 4,
    "published" : false,
    "inventory" : 2,
