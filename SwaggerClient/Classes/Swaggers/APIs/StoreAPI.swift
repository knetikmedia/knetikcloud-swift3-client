...
open class StoreAPI: APIBase {
  ...
  "properties" : [ {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func createStoreItem(storeItem: StoreItem? = nil, completion: @escaping ((_ data: StoreItem?,_ error: Error?) -> Void)) {
        createStoreItemWithRequestBuilder(storeItem: storeItem).execute { (response, error) -> Void in
            completion(response?.body, error);
        }
    }
  ...
  "category" : "aeiou"
     ...
     */
    open class func createStoreItemWithRequestBuilder(storeItem: StoreItem? = nil) -> RequestBuilder<StoreItem> {
  ...
  "first" : true
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func updateItemTemplate(id: String, itemTemplateResource: StoreItemTemplateResource? = nil, completion: @escaping ((_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func updateItemTemplateWithRequestBuilder(id: String, itemTemplateResource: StoreItemTemplateResource? = nil) -> RequestBuilder<Void> {
        var path = "/store/items/templates/{id}"
        path = path.replacingOccurrences(of: "{id}", with: "\(id)", options: .literal, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
        let parameters = itemTemplateResource?.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func updateStoreItem(id: Int32, storeItem: StoreItem? = nil, completion: @escaping ((_ error: Error?) -> Void)) {
        updateStoreItemWithRequestBuilder(id: id, storeItem: storeItem).execute { (response, error) -> Void in
            completion(error);
        }
    }
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func updateStoreItemWithRequestBuilder(id: Int32, storeItem: StoreItem? = nil) -> RequestBuilder<Void> {
        var path = "/store/items/{id}"
        path = path.replacingOccurrences(of: "{id}", with: "\(id)", options: .literal, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
        let parameters = storeItem?.encodeToJSON() as? [String:AnyObject]
