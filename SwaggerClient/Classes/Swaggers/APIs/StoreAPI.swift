...
open class StoreAPI: APIBase {
  ...
  "skus" : [ {
    "sale_id" : 0,
    "original_price" : 2.913027260511635,
    "description" : "aeiou",
    "stop_date" : 9,
    "published" : false,
    "inventory" : 1,
  ...
  "properties" : [ {
    ...
    open class func getBehaviorsWithRequestBuilder() -> RequestBuilder<[BehaviorDefinitionResource]> {
        ...
        let requestBuilder: RequestBuilder<[BehaviorDefinitionResource]>.Type = SwaggerClientAPI.requestBuilderFactory.getBuilder()
  ...
  "content" : [ {
    ...
    "skus" : [ {
      "sale_id" : 9,
      "original_price" : 3.8095609603734895,
      "description" : "aeiou",
      "stop_date" : 1,
      "published" : false,
      "inventory" : 2,
  ...
  "skus" : [ {
    "sale_id" : 2,
    "original_price" : 7.030938612479503,
    "description" : "aeiou",
    "stop_date" : 7,
    "published" : false,
    "inventory" : 7,
  ...
  "content" : [ {
    ...
    "skus" : [ {
      "sale_id" : 3,
      "original_price" : 8.010484368294911,
      "description" : "aeiou",
      "stop_date" : 3,
      "published" : false,
      "inventory" : 4,
  ...
  "skus" : [ {
    "sale_id" : 4,
    "original_price" : 5.891451222080049,
    "description" : "aeiou",
    "stop_date" : 6,
    "published" : false,
    "inventory" : 8,
