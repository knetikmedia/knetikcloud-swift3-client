...
open class StoreAPI: APIBase {
  ...
  "properties" : [ {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getItemTemplatesUsingGET(size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: @escaping ((_ data: PageStoreItemTemplateResource?,_ error: Error?) -> Void)) {
  ...
  "first" : true
     ...
     */
    open class func getItemTemplatesUsingGETWithRequestBuilder(size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageStoreItemTemplateResource> {
        let path = "/store/items/templates"
        let URLString = SwaggerClientAPI.basePath + path
  ...
  "category" : "aeiou"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getStoreItemsUsingGET(filterNameSearch: String? = nil, filterUniqueKey: String? = nil, filterPublished: Bool? = nil, filterDisplayable: Bool? = nil, filterStart: String? = nil, filterEnd: String? = nil, filterStartDate: String? = nil, filterStopDate: String? = nil, filterSku: String? = nil, filterPrice: String? = nil, filterTag: String? = nil, filterItemsByType: String? = nil, filterBundledSkus: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: @escaping ((_ data: PageStoreItem?,_ error: Error?) -> Void)) {
  ...
  "first" : true
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getUsingGET2(storeListRequest: StoreListRequest? = nil, completion: @escaping ((_ data: PageStoreItem?,_ error: Error?) -> Void)) {
  ...
  "first" : true
     ...
     - returns: RequestBuilder<PageStoreItem> 
     */
    open class func getUsingGET2WithRequestBuilder(storeListRequest: StoreListRequest? = nil) -> RequestBuilder<PageStoreItem> {
        let path = "/store"
        let URLString = SwaggerClientAPI.basePath + path
