...
open class LogsAPI: APIBase {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getEventsLogsUsingGET(filterStartDate: String? = nil, filterEventName: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: @escaping ((_ data: PageBreEventLog?,_ error: Error?) -> Void)) {
     ...
     */
    open class func getEventsLogsUsingGETWithRequestBuilder(filterStartDate: String? = nil, filterEventName: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageBreEventLog> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getForwardLogsUsingGET(filterStartDate: String? = nil, filterEndDate: String? = nil, filterStatusCode: Int32? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: @escaping ((_ data: PageForwardLog?,_ error: Error?) -> Void)) {
     ...
     */
    open class func getForwardLogsUsingGETWithRequestBuilder(filterStartDate: String? = nil, filterEndDate: String? = nil, filterStatusCode: Int32? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageForwardLog> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getUserLogsUsingGET1(filterUser: Int32? = nil, filterActionName: String? = nil, size: Int32? = nil, page: Int32? = nil, completion: @escaping ((_ data: PageUserActionLog?,_ error: Error?) -> Void)) {
     ...
     */
    open class func getUserLogsUsingGET1WithRequestBuilder(filterUser: Int32? = nil, filterActionName: String? = nil, size: Int32? = nil, page: Int32? = nil) -> RequestBuilder<PageUserActionLog> {
        let path = "/audit/logs"
        let URLString = SwaggerClientAPI.basePath + path
