...
open class LocationsAPI: APIBase {
     ...
     */
    open class func getCities(countryCodeIso3: String, stateCode: String, completion: @escaping ((_ data: [CityResource]?,_ error: Error?) -> Void)) {
  ...
  "state_code" : "aeiou"
     ...
     */
    open class func getCitiesWithRequestBuilder(countryCodeIso3: String, stateCode: String) -> RequestBuilder<[CityResource]> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getCountries1(completion: @escaping ((_ data: [CountryResource]?,_ error: Error?) -> Void)) {
  ...
  "iso3" : "aeiou"
     ...
     */
    open class func getCountries1WithRequestBuilder() -> RequestBuilder<[CountryResource]> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getCountries2(countryCodeIso3: String, completion: @escaping ((_ data: [StateResource]?,_ error: Error?) -> Void)) {
  ...
  "id" : 123
     ...
     */
    open class func getCountries2WithRequestBuilder(countryCodeIso3: String) -> RequestBuilder<[StateResource]> {
