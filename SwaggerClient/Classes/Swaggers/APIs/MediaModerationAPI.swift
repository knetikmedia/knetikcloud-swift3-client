...
open class MediaModerationAPI: APIBase {
     ...
     */
    open class func getModerationReport(id: Int64, completion: @escaping ((_ error: Error?) -> Void)) {
     ...
     */
    open class func getModerationReportWithRequestBuilder(id: Int64) -> RequestBuilder<Void> {
