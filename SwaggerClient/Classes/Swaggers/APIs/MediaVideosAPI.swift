...
open class MediaVideosAPI: APIBase {
  ...
  "content" : "aeiou"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func addVideoFlag(videoId: Int64, reason: String? = nil, completion: @escaping ((_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func addVideoFlagWithRequestBuilder(videoId: Int64, reason: String? = nil) -> RequestBuilder<Void> {
