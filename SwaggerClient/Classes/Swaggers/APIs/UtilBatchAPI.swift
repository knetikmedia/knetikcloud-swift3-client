...
open class UtilBatchAPI: APIBase {
     ...
     */
    open class func sendBatch(batch: Batch? = nil, completion: @escaping ((_ error: Error?) -> Void)) {
     ...
     */
    open class func sendBatchWithRequestBuilder(batch: Batch? = nil) -> RequestBuilder<Void> {
        let path = "/batch"
