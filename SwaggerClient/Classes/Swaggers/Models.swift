...
class Decoders {
    ...
    private static var __once: () = {
        ...
        Decoders.addDecoder(clazz: PageAchievementDefinitionResource.self) { (source: AnyObject) -> PageAchievementDefinitionResource in
            ...
            instance.sort = Decoders.decodeOptional(clazz: Sort.self, source: sourceDictionary["sort"] as AnyObject?)
        ...
        Decoders.addDecoder(clazz: Sort.self) { (source: AnyObject) -> Sort in
            ...
            fatalError("Source \(source) is not convertible to typealias Sort: Maybe swagger file is insufficient")
        }
        ...
        Decoders.addDecoder(clazz: StoreListRequest.self) { (source: AnyObject) -> StoreListRequest in
            ...
            instance.ignoreLocation = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["ignore_location"] as AnyObject?)
            instance.inStockOnly = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["in_stock_only"] as AnyObject?)
            ...
            instance.useCatalog = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["use_catalog"] as AnyObject?)
            return instance
        }
