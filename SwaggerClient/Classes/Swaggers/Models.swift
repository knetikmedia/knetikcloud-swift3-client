...
class Decoders {
    ...
    private static var __once: () = {
        ...
        Decoders.addDecoder(clazz: AchievementDefinitionResource.self) { (source: AnyObject) -> AchievementDefinitionResource in
            ...
            instance.maxValue = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["max_value"] as AnyObject?)
            instance.minValue = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["min_value"] as AnyObject?)
        ...
        Decoders.addDecoder(clazz: BillingReport.self) { (source: AnyObject) -> BillingReport in
            ...
            instance.scheduled = Decoders.decodeOptional(clazz: Int64.self, source: sourceDictionary["scheduled"] as AnyObject?)
